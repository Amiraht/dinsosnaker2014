...
<form action="./modules/stafkasiwasnaker/lembar_disposisi/disposisi_validate.php?link=<?php echo $resi; ?>&id_user=<?php echo $userid; ?>&status=<?php echo $sta; ?>" method="POST">
<table>
<tr>
	<td>DISPOSISI
