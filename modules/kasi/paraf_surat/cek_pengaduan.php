...
<script type="text/javascript">
	...
	g='../../../index.php?mod=kasi&opt=lembar_disposisi&opts=tolak&link='+w+'&id_user='+uid;
	...
	<legend>PARAF SURAT PEMANGGILAN</legend>
	   <p>
		<label>
		  ...
		  BERKAS SURAT PEMANGGILAN SUDAH DICEK <a href="../../penomoran/<?php echo $panggilan;?>.php?link=<?php echo $no_resi;?>" target="_blank">(LIHAT DRAFT)</a></label>
		<br>
		<label>
