        ...
        <div class="bodypanel" id="bodyfilter">
            <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
                ...
                <tr>
                    ...
                    <td width='10px'>:</td>
                    <td>
                        <input type="text" name="dari" id="dari" value="<?php echo($_POST["dari"]); ?>" style="width: 100px;" />
                        S/D
                        <input type="text" name="sampai" id="sampai" value="<?php echo($_POST["sampai"]); ?>" style="width: 100px;" />
                    </td>
                </tr>
            </table>
            ...
            <table border="0px" cellspacing='0' cellpadding='0' width='40%'>
                <tr>
                    <td width='33%'><input type="submit" name="filter" value='Filter' style="width: 100%;" /></td>
    ...
    <table border="0px" cellspacing='0' cellpadding='0' width='100%' class="listingtable">
        ...
        <?php
            ...
            $res = mysql_query("SELECT
                                ...
                                WHERE
                                	a.id_jenis_arsip='1' AND a.id_pengguna='47' " . $whr_kakan . " " . $whr . "
                                ORDER BY
                                	a.tahun");
            $ctr = 0;
