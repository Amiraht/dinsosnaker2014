...
<?php
    ...
    $sql_list_pegawai = "SELECT
                        ...
                        FROM
                        	...
                        	LEFT JOIN tbl_usulan_cerai e ON (a.id_pegawai = e.id_pegawai AND e.no_usulan = '" . $no_usulan . "' AND e.diproses=0)
                        WHERE
...
function terima(id_usulan){
    document.location.href="?mod=cerai_proses&id_usulan=" + id_usulan + "&no_usulan=<?php echo $no_usulan; ?>";
}
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">DAFTAR PEGAWAI DALAM PROSES CERAI</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>DAFTAR PEGAWAI DALAM PROSES CERAI</span></td>
