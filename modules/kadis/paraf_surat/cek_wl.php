...
<script type="text/javascript">
	...
	g='../../../index.php?mod=kadis&opt=lembar_disposisi&opts=tolak&link='+w+'&id_user='+uid;
...
<fieldset>
    ...
    <?php echo'
					  ...
					  <tr>
						...
						if($result["limbah3"]==1)
							{echo'<label><input type="checkbox" disabled checked disabled name="limbah3" value="1" >GAS</label><br/>';}
						else
					  ...
					  <tr><td>&nbsp;</td></tr>        
					  <tr>
						<td height="28px">INSTALASI PENGOLAH LIMBAH</td>
						<td width="20">:</td>
	...
	<?php
        ...
        {
            $link="<a href=../../penomoran/cetak_wl.php?link=$no_resi target=_blank>(LIHAT DRAFT)</a>";
        }
        else
        {
            $link="";
	...
	<legend>PARAF SURAT PEMANGGILAN</legend>
	   <p>
        <label>
          ...
          BERKAS DRAFT SK PENUGASAN SUDAH DI CEK <?php echo $link;?></label>
        <br>
        <label>
          <input type="checkbox" name="berkas" value="2" id="berkas_1">
          BERKAS DRAFT SK PENUGASAN SUDAH DITANDATANGANI</label>
        <br>
	  </p>
	<center>
    	<?php
