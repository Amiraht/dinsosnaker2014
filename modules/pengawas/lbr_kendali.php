...
<script type="text/javascript">
	function Kirim_Cari()
	{
		...
		var s;
		s='./index.php?mod=pengawas&opt=lembar_kendali';
	...
	function edit_data(c,uid)
	{
			...
			if(t.innerHTML != ''){
				...
				t.innerHTML='<iframe src="./modules/pengawas/lembar_kendali/edit.php?link='+c+'&id_user='+uid+'" width="100%" style="height:300px" frameborder="0" scrolling="yes" id="iframe_detail"></iframe>';
	...
	{
		var s;
		s='./index.php?mod=pengawas&opt=lihat_kendali';
		if(k != '')
		s=s+'&link='+k;
		if(uid != '')
		s=s+'&id_user='+uid;
	...
	function lihat_data(k,uid)
	{
			...
			if(t.innerHTML != ''){
				...
				t.innerHTML='<iframe src="./modules/pengawas/lembar_kendali/lihat.php?link='+k+'&id_user='+uid+'" width="100%" style="height:300px" frameborder="0" scrolling="yes" id="iframe_detail"></iframe>';
