  ...
  <tr>
    <td height="124" colspan="2"><div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
          <table border="0" id='atasan'">
        	<tr>
		         <td colspan='2' style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00; href="#">PENCARIAN DAN PENDAFTARAN PERUSAHAAN</a></td>
            </tr>
            <tr>
    ...
    <td align="left" valign="middle">
	  ...
	  <tr>
                 		  ...
                 		  <tr>
                 		    <td>ALAMAT</td>
                 		    <td>:</td>
                 		    <td colspan="5"><input type='text' name='alamat' value='<?php echo $dataasli[1];?>'/></td>
               		    </tr>
                 		  <tr>
                 		    <td>KECAMATAN</td>
                 		    <td>:</td>
                            <td><select id="kecamatan" name="kecamatan" onChange="getKab()" selected=selected style="text-transform:uppercase;">
                 		  ...
                 		  <tr>
                 		    ...
                 		    <td>:</td>
                 		    <td>
                            	<select id="kelurahan" name="kelurahan" selected=selected style='text-transform:uppercase;'>
                 		  ...
                 		  <tr>
                 		    ...
                 		    <td>:</td>
                 		    <td><input type='date' name='tgl_diri' value='<?php echo $dataasli[7]?>'/></td>
                 		    <td colspan="4">&nbsp;</td>
               		    </tr>
                 		  <tr>
                 		   <td>JENIS USAHA</td>
                 		  ...
                 		  <tr>
                 		    ...
                 		    <td width="7%">:</td>
                 		    <td colspan="5"><select name="status_pemilik">
                 		  ...
                 		  <tr>
                 		    ...
                 		    <td>:</td>
                 		    <td colspan="5"><select name="status_modal">
