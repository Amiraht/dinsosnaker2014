...
if ($_GET["mode"]=='1')
{
	...
	HeaderingExcel('Laporan_imta.xls');
	...
	// tabel title=================================================================================
	$worksheet1->write_string(2,1,"LAPORAN IMTA",$fBesar);
	...
	if(!empty($_GET["tgl1"]) || !empty($_GET["tgl2"]) || !empty($_GET["cari"]) || !empty($_GET["no_resi"]))
	{
		$query = mysql_query("select no_resi,tgl_masuk_berkas,nama_ta,alamat_ta,kewarganegaraan,jlh_setoran_dpkk,tgl_imta,tgl_berakhir from vw_imta_baru where nama_ta is not null and ".$up."");
	}
	else
	{						
		$query = mysql_query("select no_resi,tgl_masuk_berkas,nama_ta,alamat_ta,kewarganegaraan,jlh_setoran_dpkk,tgl_imta,tgl_berakhir from vw_imta_baru where nama_ta is not null ");
	}	
