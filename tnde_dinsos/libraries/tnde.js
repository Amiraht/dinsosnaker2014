...
function disposisi(id_surat, id_disposisi){
	 ...
	 if(t.innerHTML != ''){
		...
		t.innerHTML='<iframe src="./isi/panel/modal/dialog_frm_dsp.php?id_surat_masuk='+id_surat+'&id_disposisi='+id_disposisi+'" width="100%" style="height:1300px" frameborder="0" scrolling="yes"' + 
