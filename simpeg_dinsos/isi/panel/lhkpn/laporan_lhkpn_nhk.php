...
function proses(){
    ...
    if(tahun == "")
        jAlert("Maaf, tahun Periode NHK harus diisi", "PERHATIAN");
    else
        $("#frm").submit();
}
</script>
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">LAPORAN NHK LHKPN</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>LAPORAN NHK LHKPN</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
			<form name="frm" id="frm" action="cetak/laporan_tabel/lhkpn/laporan_lhkpn_nhk.php" method="post" target="_blank">
				<div class="panelcontainer" style="width: 100%;">
					...
					<div class="bodypanel bodyfilter" id="bodyfilter">
						...
						<table>
							<tr>
								<td>
									<label>Tahun Periode NHK :</label>
									<input type="text" style='width:90%;' name="tahun" id="tahun" placeholder=":: Tahun Periode NHK ::" />
								</td>
								<td>&nbsp;</td>
							</tr>
						</table>
