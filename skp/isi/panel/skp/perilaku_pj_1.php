...
<script type="text/javascript">
    ...
    function lanjut(id){
        document.location.href="php/set_pegawai.php?id=" + id + "&mod=perilaku_pilih_periode";
    }
</script>
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">DATA PERILAKU PEGAWAI SKPD</a></h1>
                                </td>	
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>DATA PERILAKU PEGAWAI SKPD</span></td>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
			<form name="frm" action="?mod=<?php echo($_GET["mod"]); ?>" method="post">
				<div class="panelcontainer" style="width: 100%;">
					<h3 style="text-align: left; background-color: green; color:white;"><div style="display: block; float: left;"><div style="clear: both;"></div>FILTER DATA PENCARIAN</div><input type="button" value="+" style="float: right; display: block; font-weight: bold;" id="expand" /><div style="clear: both;"></div></h3>
				...
				<div class="kelang"></div>
				<div class="panelcontainer" style="width: 100%;">
					<h3 style="text-align: left; background-color: green; color:white;">DAFTAR PEGAWAI DI SKPD <?php echo(strtoupper(nama_skpd($_SESSION["simpeg_id_skpd"]))); ?></h3><br/>
					<span></span>
					<div class="bodypanel">
					<table border="0px" cellspacing='0' cellpadding='0' width='100%' class="listingtable">
						...
						<tbody>
						<?php
							// tentukan limit dari setiap file yang akan ditampilkan
							// secara default ditampilkan dalam jumlah 100 buah data
							$limit = 100;
							
							$nama = isset($_POST["nama_pegawai"]) ? $_POST["nama_pegawai"] : "";
							$nip = isset($_POST["nip"]) ? $_POST["nip"] : "";
						
							$whr = " AND a.nama_pegawai LIKE '%" . $nama . "%' AND a.nip LIKE '%" . $nip . "%' ";
