...
<form name="frm" id="frm" action="cetak/cetak_laporan_belum_ngisi_dp3_adm.php" method="post" target="_blank">
<div class="panelcontainer" style="width: 100%;">
    ...
    <div class="bodypanel bodyfilter" id="bodyfilter">
        ...
        <table>
            <tr>
                <td width="30%">
                    <label>Tahun Penilaian Prestasi Kerja Belum Diisi :</label>
                    <input type="text" name="tahun" id="tahun" placeholder=":: Tahun Penilaian Prestasi Kerja ::" />
                </td>
                <td>&nbsp;</td>
            </tr>
        </table>
