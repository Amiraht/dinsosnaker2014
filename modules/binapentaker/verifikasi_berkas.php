...
function tampil(c)
{
		...
		if(t.innerHTML != ''){
			...
			t.innerHTML='<iframe src="./modules/binapentaker/verifikasi_berkas/tampil.php?link='+c+'" width="100%" style="height:1500px" frameborder="0" scrolling="yes" id="iframe_detail"></iframe>';
				...
				if(isset($_POST["cari"]))
					{
					...
					else
						{
							$query = mysql_query("SELECT
											...
											WHERE		
												a.id_proses_skrg = '35' AND a.isDisposisi = '0'
											LIMIT ".$posisi.",".$batas."");
						}
...
<?php
		...
		if($_GET["opts"] == 'tolak')
			include('./modules/binapentaker/verifikasi_berkas/tolak.php');
