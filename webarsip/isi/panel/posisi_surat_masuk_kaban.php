...
function munculDisposisi(id_surat_masuk, id_disposisi){
    var t = document.getElementById("div_cek_"+id_surat);
	 if(t.innerHTML != ''){
		...
		t.innerHTML='<iframe src="./isi/panel/dialog/posisi_surat_masuk_kaban.php.php?id_surat_masuk='+id_surat+'&id_disposisi='+id_disposisi+'" ' +
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
              ...
              <table border="0" id='atasan'>
                        ...
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>POSISI SURAT MASUK KABAN</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
			...
			<br/><br/>
			<fieldset>
				<h3>DAFTAR SURAT MASUK YANG DITERIMA</h3><br/><br/>
