...
<script type="text/javascript">
	...
	function lihat_data(k,uid)
	{
			...
			if(t.innerHTML != ''){
				...
				t.innerHTML='<iframe src="./modules/kabidhubsaker/lembar_kendali/lihat.php?link='+k+'&id_user='+uid+'" width="100%" style="height:300px" frameborder="0" scrolling="yes" id="iframe_detail"></iframe>';
      ...
      <table border="0" id='atasan'>
            ...
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
				  <img src="./image/panah.gif"  /><a href="./index.php?mod=kabidhubsaker&opt=main" id="linkutama"> BERANDA LOGIN KABIDHUBSAKER</a> 
				...
				<?php 
					...
					echo "
							...
							echo "<td>".$set['alamat_pemohon']."</td>"; 
							 echo "
								<td> <input type='button' value='DETAIL' onClick=$onc3></td>
							 </tr> 	
							";
