<div class="panelcontainer" style="width: 100%;">
    <h3>PROSES PEMINJAMAN DIGITAL</h3>
    <div class="bodypanel">
  ...
  <tr>
    <td>
        ...
        <table border="0" style="float:right; margin-top:70px; font-size:18px; font-weight:bold;">
        	<tr>
		         <td style="text-align:right; padding-right:10px; height:20px;"><a style="color:#AA9F00;" href="">PROSES PEMINJAMAN DIGITAL</a></td>
            </tr>
        </table>
        </div>
     </td>
   ...
   <div id='content' style='margin-left:5%;width:90%;min-height:350px;'>
	...
	<tr>
		...
		<td style="padding-left:30px;" id='menudepan'>  
			<img src='./image/list.png'>&nbsp;<a href="php/awal_pin_dig.php">PROSES PERMOHONAN</a><br /><br />
			<img src='./image/list.png'>&nbsp;<a href="?mod=peminjaman_digital">PROSES LIHAT ARSIP</a><br /><br />
			<img src='./image/list.png'>&nbsp;<a href="./"  class="menu">BERANDA UTAMA</a><br /><br />
	   </td>
	</tr>
	</table>
	</div>
