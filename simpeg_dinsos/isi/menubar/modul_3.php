<?php
	...
	switch($_SESSION["id_level"]){
		case 17 :
				$url_main = "../index.php?mod=kadis&opt=utama";
				break;		
		case 4  :
				$url_main = "../index.php?mod=kabidhubsaker&opt=utama";
				break;
		case 7  :
				$url_main = "../index.php?mod=kabidpentaker&opt=utama";
				break;
		case 11 :
				$url_main = "../index.php?mod=kabidwasnaker&opt=utama";
				break;
		case 22 :
				$url_main = "../index.php?mod=kabidlatih&opt=utama";
				break;
	}
?>
  ...
  <tr>
    <td>
        ...
        <table border="0" style="float:right; margin-top:70px; font-size:18px; font-weight:bold;">
        	<tr>
		         <td style="text-align:right; padding-right:10px; height:20px;"><a style="color:#AA9F00;" href="./">BAGIAN SKPD</a></td>
            </tr>
        </table>
        </div>
     </td>
