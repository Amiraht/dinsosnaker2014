...
<legend style="font-family:verdana; font-size:12px;"><b>Tambah Data Pegawai</b></legend>
...
<tr id="tbl-content">
	<td width="40%">NIP PEGAWAI</td>
    <td><input type="text" name="nip" maxlength="100" style="font-family:verdana; font-size:10px;" size="30"/></td>
</tr>
<tr id="tbl-content">
	<td>GELAR DEPAN</td>
    <td><input type="text" name="gelar_depan" style="font-family:verdana; font-size:10px;" size="30"/></td>
</tr>
<tr id="tbl-content">
	<td>NAMA PEGAWAI</td>
    <td><input type="text" name="nama_pegawai" style="font-family:verdana; font-size:10px;" size="30"/></td>
</tr>
<tr id="tbl-content">
	<td>GELAR BELAKANG</td>
    <td><input type="text" name="gelar_belakang" style="font-family:verdana; font-size:10px;" size="30"/></td>
</tr>
<tr id="tbl-content">
	<td >PASSWORD</td>
