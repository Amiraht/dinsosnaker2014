...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
          ...
          <table border="0" id='atasan'">
            ...
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='index.php?mod=jamsostek&do=main'> <span></span> BERANDA UTAMA LOGIN JAMSOSTEK</a>
                     <span> </span> <img src="./image/panah.gif" /> <span> </span> <a href="index.php?mod=jamsostek&do=daftar">PENCARIAN DAN PENDAFTARAN PERUSAHAAN</a>
  ...
  <tr>
    ...
    <form action="./index.php?mod=jamsostek&do=daftar&act=validate" method='post'>
