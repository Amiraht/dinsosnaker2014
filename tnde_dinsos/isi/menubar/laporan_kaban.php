  ...
  <tr>
    <td>
        ...
        <table border="0" style="float:right; margin-top:70px; font-size:18px; font-weight:bold;">
        	<tr>
		         <td style="text-align:right; padding-right:10px; height:20px;"><a style="color:#AA9F00;" href="<?=$url_main;?>">BERANDA UTAMA KABAN</a></td>
            </tr>
        </table>
        </div>
     </td>
   ...
   <div id='content' style='margin-left:5%;width:90%;min-height:350px;'>
	...
	<tr>
		...
		<td style="padding-left:30px;" id='menudepan'>  
            ...
            <img src='./image/list.png'>&nbsp;<a href="./?mod=laporan_mntkbn" class="menu">LAPORAN PEMROSESAN SURAT MASUK</a><br /><br />
