...
function disposisi(id){
    confirm("Anda yakin akan mendisposisikan data surat masuk ini?", "PERHATIAN", function(r){
        if(r){
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">DAFTAR SURAT MASUK KASUBBID</a></h1>
                                </td>
                        </tr>
                        <tr>
				...
				<?php
					...
					while($ds = mysql_fetch_array($res)){
						...
						<table border="0px" cellspacing='0' cellpadding='0' width='100%'>
							...
							<tr>
								<td colspan="3">
									<input type="button" value="Laporan Selesai Proses Ke Bidang" onclick="disposisi(<?php echo($ds["id"]) ?>);" />
								</td>
							</tr>
						</table>
						<?php
