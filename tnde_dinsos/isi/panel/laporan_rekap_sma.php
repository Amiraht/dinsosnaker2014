...
function disposisi(id_surat, id_disposisi){
	 ...
	 if(t.innerHTML != ''){
		...
		t.innerHTML='<iframe src="./isi/panel/modal/dialog_frm_dsp_sekretaris.php?id_surat_masuk='+id_surat+'&id_disposisi='+id_disposisi+'" width="100%" style="height:1300px" frameborder="0" ' + 
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'">
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00; href="./?mod=laporan_rekap_sma">LAPORAN REKAP SURAT MASUK</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span> </span>LAPORAN REKAP SURAT MASUK <br/>
 ...
 <fieldset>
    <legend><h3>REKAPITULASI SURAT MASUK YANG TELAH DIARSIPKAN</h3></legend>
    ...
    <?php
        $whr = "";
        $sql = "";
        if($_SESSION["id_level"]==1 || $_SESSION["id_level"]==2 || $_SESSION["id_level"]==18 || $_SESSION["id_level"]==19){
            if($_POST["no_surat"] <> "")
            ...
            $sql = "SELECT 
                    ...
                    FROM 
                        ...
                        LEFT JOIN myapp_archivetable_suratmasuk d ON a.id = d.id_surat_masuk
                    WHERE
                    	1 AND d.id_surat_masuk IS NOT NULL AND " . $tmbh . $whr . "
                    GROUP BY
                        a.id
                    ORDER BY 
                    	id DESC";
        ...
        while($ds = mysql_fetch_array($res)){
            ...
            echo("<tr>");
                ...
                echo("<td align='center'>");
                    echo("<img src='image/Info-32.png' width='18px' class='linkimage' title='Detail Surat Masuk' onclick='lihat_detail_sma(" . $ds["id"] . ", 0);'>");
                echo("</td>");
                echo("<td align='center'>");
