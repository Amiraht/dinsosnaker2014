        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="./?mod=lacak_surat_masuk">POSISI DATA SURAT MASUK</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='<?=$url_main;?>'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>POSISI DATA SURAT MASUK</span>
...
<fieldset>
    ...
    <table border="1" width="100%" align="left" cellpadding="5" cellspacing="1" class='tblisi'>
        <tr>
            ...
            <td>Perihal</td>
            <td width='250px'>Unit Pengirim</td>
            <td width='100px'>Harus Selesai</td>
            <td width='20px'>&nbsp;</td>
            <td width='20px'>&nbsp;</td>
            <td width='20px'>&nbsp;</td>
            <td width='20px'>&nbsp;</td>
