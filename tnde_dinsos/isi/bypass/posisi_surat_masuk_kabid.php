...
<!-- DIALOG -->
<div id="dialog_form_disp" title="Lanjutkan Surat Ke Kepala Sub Bidang Yang Dituju">
<form name="frm" action="phpbypass/posisi_surat_masuk_kabid.php" method="post">
    <div class="panelcontainer" style="width: 100%;">
        <div class="bodypanel">
            <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
                ...
                <?php
                    $res_ldb = mysql_query("SELECT * FROM myapp_reftable_levelpengguna WHERE atasan='" . $_SESSION["bypass_id_level"] . "' AND id <> 2 AND urutan < 4");
                    while($ds_ldb = mysql_fetch_array($res_ldb)){
                ?>
                <tr>
                    <td width='5px'><input type="checkbox" name="id_level_tujuan_<?php echo($ds_ldb["id"]); ?>" /></td>
                    <td width='30%' style="text-transform: capitalize;"><?php echo($ds_ldb["level"]); ?></td>
                ...
                ?>
                <tr>
                    <td colspan="3"><textarea name="catatan" placeholder="JIKA SURAT MASUK DIKEMBALIKAN KE SEKRETARIS, TULIS CATATANNYA DISINI"></textarea></td>
                </tr>
            </table>
            ...
            <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
                <tr>
                    ...
                    <td width='50%'><input type="submit" name="tolak" value='Kembalikan Ke Sekretaris' style="width: 100%;" /></td>
                </tr>
                <!--<tr>
