...
<script type="text/javascript">
	...
	s='../../../index.php?mod=kasiwasnaker&opt=lembar_disposisi&opts=terima&link='+x+'&id_user='+uid;
		parent.document.location.href=s;
	}
	function tolak(uid){
	var w = '<?php echo "$no_resi"; ?>';
	g='../../../index.php?mod=kasiwasnaker&opt=lembar_disposisi&opts=tolak&link='+w+'&id_user='+uid;
...
<fieldset>
    ...
    <form name="form1" method="post" action="../../../index.php?mod=stafkasiwasnaker&opt=cetak&link=<?php echo"$no_resi"?>" target="_blank">    
