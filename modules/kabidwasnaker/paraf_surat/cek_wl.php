...
<script type="text/javascript">
	...
	g='../../../index.php?mod=kabidwasnaker&opt=lembar_disposisi&opts=tolak&link='+w+'&id_user='+uid;
...
<fieldset>
    ...
    <form name="form1" method="post" action="../../../index.php?mod=stafkabidwasnaker&opt=cetak&link=<?php echo"$no_resi"?>" target="_blank">    
