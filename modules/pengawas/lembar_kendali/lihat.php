      ...
      <table border="0" id='atasan'>
            ...
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
				  ...
				  <img src="./image/panah.gif"  /><a href="./index.php?mod=pengawas&opt=lembar_kendali" id="linkutama">LEMBAR KENDALI</a> 
...
<td style="float:right;">
					<img width="90" height="29" 
						onclick="document.location.href='./index.php?mod=pengawas&opt=lembar_kendali'" 
...
<form action="./modules/pengawas/lembar_kendali/cetak_disposisi.php?link=<?php echo $resi; ?>" method="POST">
