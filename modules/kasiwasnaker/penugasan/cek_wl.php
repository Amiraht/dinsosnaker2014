...
<script type="text/javascript">
	...
	s='../../../index.php?mod=kasiwasnaker&opt=lembar_disposisi&link='+x+'&id_user='+uid;
...
<fieldset>
	...
	<center>
        <?php
			...
			$onc="terima('".$userid."')";
		?>		
		<input type="button" onClick="CekAll()" value="CENTANG SEMUA"> <input type="button" onClick="<?php echo $onc?>" value="PROSES" disabled id="btn">
	</center>
<div id='div_cek'></div>
	</fieldset>
   <fieldset>
