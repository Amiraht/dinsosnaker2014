...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
       ...
       <table border="0" id='atasan'>
        	<tr>
		         <td colspan="2" style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00"; href="#"><b>PROFIL USER</b></a></td>
                    ...
                    <tr>
                  	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='index.php?mod=dinsos&do=main'> <span></span> BERANDA UTAMA LOGIN KASI PERSELISIHAN </a>
                     <span> </span> <img src="./image/panah.gif" /> <span> </span> PROFIL USER
                     </td>
  ...
  <tr >  
	...
	<fieldset>   
		...
		<br />
		<form action='index.php?mod=dinsos&do=usersimpan' method='post' name='edituser'>   
						
    <table width='100%' border='0' cellspacing='2' cellpadding='5' align="left">
