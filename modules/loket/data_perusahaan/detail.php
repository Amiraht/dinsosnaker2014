    ...
    <td height="124" colspan="2">
		<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
          <table border="0" id='atasan'">
        	<tr>
		         <td colspan='2' style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00; href="#">LIHAT DATA PERUSAHAAN</a></td>
            </tr>
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='index.php?mod=loket&opt=main'> <span></span> BERANDA UTAMA LOGIN LOKET </a>
                     <span> </span> <img src="./image/panah.gif" /> <span> </span> <a href="index.php?mod=loket&opt=daftar">PENCARIAN PERUSAHAAN</a>
	...
	$perusahaan = mysql_query("
						SELECT
							...
							FROM
								...
								LEFT JOIN tbl_tenagakerja_dinsos b ON a.id_perusahaan = b.id_perusahaan
