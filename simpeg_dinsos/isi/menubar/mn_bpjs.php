  ...
  <tr>
    <td>
        ...
        <table border="0" style="float:right; margin-top:70px; font-size:18px; font-weight:bold;">
        	<tr>
		         <td style="text-align:right; padding-right:10px; height:20px;"><a style="color:#AA9F00;" href="./?mod=mn_bpjs">BPJS</a></td>
            </tr>
        </table>
        </div>
     </td>
   ...
   <div id='content' style='margin-left:5%;width:90%;min-height:350px;'>
	...
	<tr>
		...
		<td style="padding-left:30px;" id='menudepan'>  
			<img src='./image/list.png'>&nbsp;<a href="?mod=bpjs_daftar">INPUT DATA BPJS</a><br /><br />
            <img src='./image/list.png'>&nbsp;<a href="?mod=laporan_bpjs_telah_daftar">LAPORAN DAFTAR PEGAWAI YANG TELAH MENDAFTAR BPJS</a><br /><br />
            <img src='./image/list.png'>&nbsp;<a href="?mod=laporan_bpjs_belum_daftar">LAPORAN DAFTAR PEGAWAI YANG BELUM MENDAFTAR BPJS</a><br /><br />
            <img src='./image/list.png'>&nbsp;<a href="?mod=rekap_bpjs">LAPORAN REKAP PENDAFTARAN BPJS</a><br /><br />
