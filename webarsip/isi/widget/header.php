<?php
	error_reporting(0);
	if(isset($_SESSION['id_unit_kerja']) && isset($_SESSION['id_pengguna']) && $_SESSION["id_unit_kerja"] != 0){
		$sql_pengguna = "SELECT
...
<table width='100%' border='0px' cellspacing='0' cellpadding='0'>
    <tr>
        ...
        <td style="background-color:green;">
            <div style="color:white; margin-left: -150px; text-align: center; font-family: cambria; font-size: 20pt; font-weight: bold; text-shadow: 2px 2px 1px #ccccdd;">:: SISTEM INFORMASI MANAJEMEN KEARSIPAN ::</div>
