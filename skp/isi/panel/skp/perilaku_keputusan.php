...
function proses_perilaku(stt){    
    var keputusan = frm.keputusan.value;
    if(keputusan == "")
        jAlert("Maaf, keputusan terhadap keberatan penilaian perilaku harus diisi", "PERHATIAN");
    else
        frm.submit();
}
</script>
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">DATA PERIODE PENILAIAN PERILAKU <?php echo(strtoupper(detail_pegawai($_GET["id_pegawai"], "nama_pegawai"))); ?> (NIP : <?php echo(strtoupper(detail_pegawai($_GET["id_pegawai"], "nip"))); ?>)</h3>
...
<?php
    $ds_skp = mysql_fetch_array(mysql_query("SELECT * FROM tbl_skp_perilaku WHERE id_skp_perilaku='" . $_GET["id_skp"] . "'"));
?>
<form name="frm" id="frm" action="php/skp/perilaku_keputusan.php" method="post">
        ...
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                <td>
                    ...
                    <textarea name="keputusan" placeholder="Berikan keputusan atas keberatan penilaian perilaku pegawai"><?php echo($ds_skp["keputusan"]); ?></textarea>
                </td>
            </tr>
        </table>
        <?php
        ...
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                <td style="text-align: left;">
                    <input name="terima" type="button" value="PROSES SELESAI" style="height: 40px;" onclick="proses_perilaku(1);" />
                </td>
            </tr>
        </table>
        <?php
                ...
                echo("<div style='font-family: verdana; font-weight: light; color: #458B00; font-size: 9pt; padding: 3px 10px; background-color: #EEEEEE; margin-bottom: 10px;'>Data keberatan sedang di proses oleh Pejabat Penilai</div>");
            }else if($ds_skp["status_supervisi"] == 4){
                echo("<div style='font-family: verdana; font-weight: light; color: #458B00; font-size: 9pt; padding: 3px 10px; background-color: #EEEEEE; margin-bottom: 10px;'>Data keberatan telah selesai di proses</div>");
            }
        ?>
