...
if($jenis_urus=='01')
{
	$qry="select id_pengguna,id_proses_lanjutan from tbl_alur_baru where id_proses = '".$bz[0]."' and id_pengguna='11'";
}
else
{
        	...
        	<tr>
		         <td colspan="2" style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00;" href="#"><b>LEMBAR DISPOSISI</b></a></td>
                        ...
                        <tr>
                            ...
                            <img src="./image/panah.gif"  /> <span id="linkutama">LEMBAR DISPOSISI</span></div></td>
                        </tr>
                    </table>            
                    </div>
            <br>
...
<fieldset style='width:96%; margin-left:18px; padding-left:20px;min-height:40px; margin-bottom:10px;padding-right:20px;'>
...
<form action="./modules/loket/lembar_disposisi/disposisi_validate.php?link=<?php echo $resi; ?>&id_user=<?php echo $userid; ?>" method="POST">
<table>
<tr>
	<td>DISPOSISI</td>
	<td><input type="hidden" name="sblm" value=<?php echo $bz[0];?> />:</td>
	<td> 
		<select name="tujuan">
		<?php
