...
function disposisi(id_surat, id_disposisi){
	 ...
	 if(t.innerHTML != ''){
		...
		t.innerHTML='<iframe src="./isi/panel/modal/dialog_posisi_sk_kasubbid.php?id_surat_keluar='+id_surat+'&id_disposisi='+id_disposisi+'" width="100%" style="height:1300px" frameborder="0" ' + 
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="./?mod=posisi_surat_keluar_kasubbid">SURAT KELUAR KASUBBID</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='<?=$url_main;?>'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>SURAT KELUAR</span>
		...
		<form name="frm" action="?mod=<?php echo($_GET["mod"]); ?>" method="post">
            ...
            <table border="0px" cellspacing='0' cellpadding='0' width='40%'>
                <tr>
                    ...
                    <td><input type="reset" value='Reset' style="width: 100%;" /></td>
                </tr>
            </table>
      </form>
	</fieldset><br/><br/>  
