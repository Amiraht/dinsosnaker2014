	...
	function Kirim_Cari()
	{
		...
		var s;
		s='index.php?mod=loket&opt=daftar&act=search';
  ...
  <tr>
    ...
    <div id='content' style='margin-left:2%;margin-bottom:20px;width:98%;'>
	    ...
	    <legend>FILTER</legend>
					<form name='fcari' action='index.php?mod=loket&opt=daftar&act=search' method='POST'>
				...
				if(!empty($_GET["cari"]))
				{
					...
					$a = "SELECT result.*
										FROM(
											...
											(
												SELECT
													b.id_perusahaan, b.nama, b.alamat, b_kb.nama_bagian, b_ju.jenis, 'BPJS KETENAGAKERJAAN' AS sumber
												FROM
													db_jamsostek b
					...
					echo "<a href='./index.php?mod=loket&opt=daftar&act=register'>TAMBAH PERUSAHAAN</a><br><br>";
						...
						while($set=mysql_fetch_array($query))
						{
							...
							echo "<tr>
									...
									if($set[5]=='BPPT' || $set[5]=='JAMSOSTEK')
										{echo "<td align='center'> <a href='./index.php?mod=loket&opt=daftar&act=register&sumber=$set[5]&id=$set[0]'>DAFTAR PERUSAHAAN</a></td>";}
									else
										echo "<td align='center'> <a href='./index.php?mod=loket&opt=detail&id=".$set[0]."'>LIHAT PERUSAHAAN</a></td>";
							echo"	</tr>";
							$i++;
						}
					}
					...
					echo "<script type='text/javascript'>
								...
								document.location = 'index.php?mod=loket&opt=daftar&act=register';
						</script>
						";
					}					
				}
