...
<script type="text/javascript">
	...
	s='../../../index.php?mod=pengawas&opt=lembar_disposisi&opts=tolak&link='+x+'&id_user='+uid;
		parent.document.location.href=s;
	}
	
	function terima(uid){
	var x = '<?php echo "$no_resi"; ?>';
	s='../../../index.php?mod=pengawas&opt=lembar_disposisi&opts=terima&link='+x+'&id_user='+uid;
		parent.document.location.href=s;
	}	
...
<fieldset>
	   <p>
        ...
        <?php if($path != "")
		{
        	echo "<a class=menu href=../../../libraries/fdownload.php?jenis=laporan&path=".$respath['file']." target=_blank>LIHAT LAPORAN</a></label>";
		}
		?>
		<br>
	   </p>
	<center>
    	<?php
			...
			$onc1="terima('".$userid."')";
		?>	
        <input type="button" onClick="<?php echo $onc; ?>" value="TOLAK">
		<input type="button" onClick="<?php echo $onc1; ?>" value="TERIMA">
	</center>
</fieldset>
   <fieldset>
