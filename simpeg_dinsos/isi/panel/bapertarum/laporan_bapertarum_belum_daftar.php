...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
          ...
          <td>
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        ...
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./?mod=laporan_bapertarum_belum_daftar'> 
							<span></span> LAPORAN BAPERTARUM BELUM DAFTAR</a>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
		<form name="frm" id="frm" action="cetak/laporan_tabel/bapertarum/laporan_bapertarum_belum_daftar.php" method="post" target="_blank">
