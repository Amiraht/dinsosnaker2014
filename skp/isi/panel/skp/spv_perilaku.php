...
function lanjut(id_skp){
    document.location.href = "?mod=spv_perilaku_proses&id_skp=" + id_skp;
}
</script>
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">SUPERVISI PENILAIAN PERILAKU PEGAWAI</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>SUPERVISI PENILAIAN PERILAKU PEGAWAI</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
				...
				<h3 style="text-align: left;">PILIH PEGAWAI YANG AKAN DISUPERVISI PENILAIAN PERILAKU</h3>
				<div class="bodypanel">
					...
					<?php
						$res = mysql_query("SELECT
											...
											FROM
												...
												LEFT JOIN tbl_skp_perilaku f ON e.id_skp = f.id_skp
											WHERE
