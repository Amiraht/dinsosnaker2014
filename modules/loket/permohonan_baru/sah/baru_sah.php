...
<tr >
    <td colspan="2"><div id='header' style='background:url(./image/coba/header2.png) no-repeat; '> 
      <table border="0" id="atasan">
        	<tr>
		         <td colspan="2" style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00;" href="#"><b>PERMOHONAN BARU - PENGESAHAN PP</b></a></td>
            </tr>
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
				  ...
				  <img src="./image/panah.gif"  /><span id="linkutama"> PROSES PENGESAHAN PERATURAN PERUSAHAAN</span>
                 </td>
               </tr>
        </table> 
    </div>
...
<tr>
	<td>
	<h2> &nbsp; PROSES PENGURUSAN PENGESAHAN PERATURAN PERUSAHAAN</h2>
		<fieldset>
...
?>
<fieldset>
		<legend>DATA  KHUSUS PEGESAHAN PERATURAN PERUSAHAAN</legend>
		<form name="form1" method="post" action="./index.php?mod=loket&opt=proses_permohonan&opts=validate_sah&mode=1" id="form1">
				<table name="biodata" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
					  ...
					  <tr>
						...
						<td width="20">:</td>
						<td><input name="konsep_pp" type="text" size="40" class="required"></td>
					  </tr>
					  <tr>
						<td>TANGGAL BERLAKU PERATURAN PERUSAHAAN YANG BARU</td>
						<td width="20">:</td>
						<td><input name="tgl_pp" type="date" size="40" id="date2" class="required date"></td>
					  </tr>                      
					  <tr>
		...
		<legend>CHECKLIST PERSYARATAN DAN KELENGKAPAN BERKAS</legend>
			  ...
			  <p>
				...
				<label>
				  ...
				  BERKAS PERATURAN PERUSAHAAN/PERUBAHAN PP</label>
				<br>
				<label>
				...
				<label>
				  ...
				  SURAT PERNYATAAN BAHW TIDAK MEMILIKI SERIKAT KERJA JIKA MEMANG TIDAK ADA</label>
				<br>
				<label>
				  <input type="checkbox" name="berkas" value="10" id="berkas_9">
				  SURAT PERNYATAAN PERTIMBANGAN DARI SERIKAT KERJA ATAU BURUH</label>
				<br>                                
				<label>
				  <input type="checkbox" name="berkas" value="11" id="berkas_10">
				  SURAT PERSETUJUAN DARI PIMPINAN SERIKAT KERJA YANG MENYATAKAN BELUM MAMPU MENINGKATKAN MENJADI PKB (JIKA SUDAH ADA SERIKAT KERJA)</label>
				<br>                               
			  </p>
				<center>		
