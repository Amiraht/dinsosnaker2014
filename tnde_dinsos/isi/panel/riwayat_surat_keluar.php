        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="./?mod=riwayat_surat_keluar">RIWAYAT SURAT KELUAR</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='<?=$url_main;?>'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>RIWAYAT SURAT KELUAR</span></td>
...
<fieldset>
    <legend><h3>DAFTAR SURAT KELUAR YANG PERNAH DIDISPOSISI KE SAYA</h3></legend>
    ...
    <?php
        ...
        if($_SESSION["id_level"] <> 1 && $_SESSION["id_level"] <> 2 && $_SESSION["id_level"] <> 18)
            $tmbh = " AND c.id_level_tujuan = '" . $_SESSION["id_level"] . "' ";
        ...
        while($ds = mysql_fetch_array($res)){
            ...
            echo("<tr>");
                ...
                echo("<td align='center'>");
                    echo("<img src='image/Info-32.png' width='18px' class='linkimage' title='Detail Surat Keluar' onclick='lihat_detail_sk(" . $ds["id"] . ");'>");
                echo("</td>");
                echo("<td align='center'>");
			...
			echo "
					<tr id='div_if'>
						...
						<td colspan='10'> <div id='div_cek_".$ds["id"]."'></div>
					</tr>
					";
