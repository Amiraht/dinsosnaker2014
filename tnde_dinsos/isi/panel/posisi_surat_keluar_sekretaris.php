...
function disposisi(id_surat, id_disposisi){
	 ...
	 if(t.innerHTML != ''){
		...
		t.innerHTML='<iframe src="./isi/panel/modal/dialog_posisi_sk_sekretaris.php?id_surat_keluar='+id_surat+'&id_disposisi='+id_disposisi+'" width="100%" style="height:1300px" frameborder="0" ' + 
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="./?mod=posisi_surat_keluar_sekretaris"></a>SURAT KELUAR SEKRETARIS</h1>
                                </td>
                        </tr>
                        <tr>
