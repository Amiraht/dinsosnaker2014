...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">EDIT DATA SK KEPANGKATAN</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>EDIT DATA SK KEPANGKATAN</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
			...
			<form name="frm" id="frm" action="php/kpk/kenpang_daftar_sk_edit.php" method="post">
			<div class="panelcontainer panelform" style="width: 100%;">
				...
				<div class="bodypanel bodyfilter" id="bodyfilter">
					<table border="0px" cellspacing='0' cellpadding='0' width='100%'>
						<tr>
							<td>
								...
								<input type="text" style='width:90%;' name="no_sk" id="no_sk" class="form-control" value="<?=$data['no_sk']; ?>"/>
							</td>
							<td>
								<label>Tgl. SK :</label>
								<input type="text" style='width:90%;' name="tgl_sk" id="tgl_sk" class="form-control" value="<?=$data['tgl_sk']; ?>"/>
							</td>
						</tr>
						<tr>
							<td width='50%'>
								<label>Nama Pejabat Penandatangan :</label>
								<input type="text" style='width:90%;' name="nama_ttd_sk" id="nama_ttd_sk" class="form-control" value="<?=$data['nama_ttd_sk']; ?>"/>
							</td>
							<td>
								<label>NIP Pejabat Penandatangan :</label>
								<input type="text" style='width:90%;' name="nip_ttd_sk" id="nip_ttd_sk" class="form-control" value="<?=$data['nip_ttd_sk']; ?>"/>
							</td>
						</tr>
						<tr>
							<td width='50%'>
								<label>Jabatan Pejabat Penandatangan :</label>
								<input type="text" style='width:90%;' name="jabatan_ttd_sk" id="jabatan_ttd_sk" class="form-control" value="<?=$data['jabatan_ttd_sk']; ?>"/>
							</td>
							<td>
					...
					<table border="0px" cellspacing='0' cellpadding='0' width='100%'>
						<tr>
							<td align='left'>
								<input type="submit" value="SIMPAN" style="width: 150; height: 40px;" class="btn btn-success"/>
