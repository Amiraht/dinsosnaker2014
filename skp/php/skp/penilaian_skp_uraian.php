<?php
    ...
    mysql_query("DELETE FROM tbl_skp_kehadiran WHERE id_skp='" . $id_skp . "' AND bulan='" . $bulan . "'");
    ...
    mysql_query("INSERT INTO tbl_skp_kehadiran VALUES(
                    NULL, '" . $id_skp . "', '" . $bulan . "', '" . $_POST["hari"] . "', '" . $_POST["hadir"] . "', '" . $_POST["alpa"] . "', '" . $_POST["sakit"] . "', '" . $_POST["izin"] . "', '" . $_POST["cuti"] . "',
                    '" . $_POST["tugas_luar"] . "', '" . $_POST["tugas_belajar"] . "'
                )");
