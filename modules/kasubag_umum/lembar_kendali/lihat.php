      ...
      <table border="0" id='atasan'>
            ...
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
				  ...
				  <img src="./image/panah.gif"  /><a href="./index.php?mod=kasubag_umum&opt=lembar_kendali" id="linkutama">LEMBAR KENDALI</a> 
...
<td style="float:right;">
					<img width="90" height="29" 
						onclick="document.location.href='./index.php?mod=kasubag_umum&opt=lembar_kendali'" 
...
<form action="./modules/kasubag_umum/lembar_kendali/cetak_disposisi.php?link=<?php echo $resi; ?>" method="POST">
<table class="tblisi" border="1" cellpadding="0" cellspacing="0" align="center" width="100%">
    <tr align="center" height="20px">
        <th height="21px" width="130">TANGGAL</th>
        <th>DARI</th>
        <th>LEVEL</th>
        <th>KEPADA</th>
        <th>LEVEL</th>
