...
<div class="kelang"></div>
<div class="panelcontainer" style="width: 100%;">
    <h3>DAFTAR SURAT KELUAR YANG TELAH DIBUAT</h3>
    <div class="bodypanel">
    ...
    <?php
        ...
        $res = mysql_query("SELECT 
                            ...
                            WHERE
                                a.id_pengguna_pembuat = '$_SESSION[id_pengguna]' " . $whr . "
                            ORDER BY 
                            	id ASC");
        $ctr = 0;
        while($ds = mysql_fetch_array($res)){
            ...
            echo("<tr>");
                ...
                echo("</td>");
                echo("<td align='center'>");
                    echo("<img src='image/Edit-32.png' width='15px' class='linkimage' title='Edit' onclick='edit(" . $ds["id"] . ");'>");
                echo("</td>");
                echo("<td  align='center'>");
                    echo("<img src='image/Delete-32.png' width='15px' class='linkimage' title='Hapus' onclick='hapus(" . $ds["id"] . ");'>");
                echo("</td>");
            echo("</tr>");
        }
    ?>
