...
<div class="kelang"></div>
<div class="panelcontainer" style="width: 100%;">
    <h3>DAFTAR DATA ARSIP YANG BELUM DIDIGITALISASI</h3>
    <div class="bodypanel">
        ...
        <?php
            ...
            $res = mysql_query("SELECT
                                ...
                                WHERE
                                    ...
                                    AND (SELECT COUNT(*) FROM tbl_file_arsip_digital WHERE id_surat_masuk = a.id_arsip) = 0
                                ORDER BY
                                	a.tahun");
            /*echo("SELECT
                                	a.*, c.unit_kerja, d.masalah, e.jenis_arsip
...
<div class="kelang"></div>
<div class="panelcontainer" style="width: 100%;">
    <h3>DAFTAR DATA ARSIP YANG TELAH DIDIGITALISASI</h3>
    <div class="bodypanel">
    <table border="0px" cellspacing='0' cellpadding='0' width='100%' class="listingtable">
        <thead>
        <tr class="headertable">
        ...
        <?php
            $res = mysql_query("SELECT
                                ...
                                FROM
                                	...
                                	LEFT JOIN ref_jenis_arsip e ON a.id_jenis_arsip = e.id_jenis_arsip
                                WHERE
                                	a.id_jenis_arsip='1' AND a.id_unit_kerja = '" . $_SESSION["id_unit_kerja"] . "'
                                    AND (SELECT COUNT(*) FROM tbl_file_arsip_digital WHERE id_surat_masuk = a.id_arsip) > 0
                                ORDER BY
                                	a.tahun");
            /*echo("SELECT
