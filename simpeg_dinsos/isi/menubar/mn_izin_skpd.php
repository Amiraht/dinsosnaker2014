  ...
  <tr>
    <td>
        ...
        <table border="0" style="float:right; margin-top:70px; font-size:18px; font-weight:bold;">
        	<tr>
		         <td style="text-align:right; padding-right:10px; height:20px;"><a style="color:#AA9F00;" href="./?mod=izin_dari_skpd">IZIN DARI SKPD</a></td>
            </tr>
        </table>
        </div>
     </td>
   ...
   <div id='content' style='margin-left:5%;width:90%;min-height:350px;'>
	...
	<tr>
		...
		<td style="padding-left:30px;" id='menudepan'>  
			...
			<img src='./image/list.png'>&nbsp;<a href="?mod=cuti_daftar_usulan">IJIN CUTI SKPD</a><br /><br />
            <img src='./image/list.png'>&nbsp;<a href="?mod=cerai_daftar_usulan">PERMOHONAN IJIN PERCERAIAN</a><br /><br />
            <img src='./image/list.png'>&nbsp;<a href="?mod=hdr_skpd_daftar">HUKUMAN DISIPLIN RINGAN</a><br /><br />
            <img src='./image/list.png'>&nbsp;<a href="?mod=hdsb_skpd_daftar">USULAN HUKUMAN SEDANG DAN BERAT KE BKD</a><br /><br />
            <img src='./image/list.png'>&nbsp;<a href="?mod=sl_daftar_usulan">USULAN SATYA LANCANA</a><br /><br />
