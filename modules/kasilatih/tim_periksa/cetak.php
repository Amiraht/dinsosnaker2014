	...
	$bawah= '
			...
			<tr>
			 ...
			 <tr>
				<td width="80" align="left"></td>
				<td width="20" align="left"><font size="-1">2. </font></td>
				<td width="400" align="left"><font size="-1">Surat Perintah Tugas ini berlaku sejak tanggal '.$tgl_surat.' sampai dengan selesai</font></td>
			 </tr>
			 <tr>
				<td width="80" align="left"></td>
				<td width="20" align="left"><font size="-1">3. </font></td>
			...
			<tr>
				<td width="15%" align="left"></td>
				<td width="30%" align="left"></td>
				<td width="50%" align="left"><font size="-1">Pada Tanggal : </font></td>
			</tr>
			<tr>
				<td width="15%" align="left"></td>
				<td width="30%" align="left"></td>
