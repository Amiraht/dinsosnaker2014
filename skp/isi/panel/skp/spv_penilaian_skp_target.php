...
function lanjut(id_skp){
    document.location.href = "?mod=spv_penilaian_skp_target_proses&id_skp=" + id_skp;
}
</script>
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">SUPERVISI PENILAIAN SKP PEGAWAI</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>SUPERVISI PENILAIAN SKP PEGAWAI</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
			...
			<div class="panelcontainer" style="width: 100%;">
				<h3 style="text-align: left;">PILIH PEGAWAI YANG AKAN DISUPERVISI PENILAIAN SKP</h3>
				<div class="bodypanel">
					...
					<?php
						$res = mysql_query("SELECT
											...
											FROM
												...
												LEFT JOIN tbl_uraian_skp f ON e.id_skp = f.id_skp
												LEFT JOIN tbl_uraian_realisasi_skp g ON f.id_uraian_skp = g.id_uraian_skp
											WHERE
												1 AND e.id_pegawai_penilai = '" . $_SESSION["id_pegawai"] . "' AND g.status_supervisi = 1
											GROUP BY
													a.id_pegawai
											ORDER BY
													a.nama_pegawai ASC") or die(mysql_error());
