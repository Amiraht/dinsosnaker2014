...
function disposisi(id_surat, id_disposisi){
	 ...
	 if(t.innerHTML != ''){
		...
		t.innerHTML='<iframe src="./isi/panel/modal/dialog_frm_dsp_sm_staff.php?id_surat_masuk='+id_surat+'&id_disposisi='+id_disposisi+'" width="100%" style="height:1300px" frameborder="0" ' + 
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id="atasan">
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="./">PROSES SURAT MASUK STAFF</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span> </span>PROSES SURAT MASUK STAFF
...
<tr>
    ...
    <div id='menu' style='border:0px solid black;'>
                    <nav>
                            <ul>
                                    <li><img src='./image/list.png'>&nbsp;&nbsp;<a href='./?mod=main_staff'>BERANDA UTAMA</a></li>
