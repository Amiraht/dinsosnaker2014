...
function hapus(id){
    jConfirm("Anda yakin akan menghapus data ini?", "PERHATIAN", function(r){
        if(r){
            //alert("dihapus " + id);
            document.location.href = "php/cp_hapus_sm.php?id=" + id;
        }
    });
}
function edit(id){
    document.location.href = "?mod=cp_edit_sm&id=" + id;
}
        ...
        while($ds = mysql_fetch_array($res)){
            ...
            echo("<tr>");
                ...
                echo("<td align='center'>");
                    echo("<img src='image/information_32.png' width='18px' class='linkimage' title='Detail Surat Masuk' onclick='lihat_detail_sm(" . $ds["id"] . ");'>");
                echo("</td>");
                echo("<td align='center'>");
