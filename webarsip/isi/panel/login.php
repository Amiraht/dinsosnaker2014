    ...
    <td>
     <div id='content' style='margin-left:5%; width:90%;min-height:350px;'>
			...
			<form name="frmlogin" action="php/login.php" method="post">
                ...
                ?>
                    <tr>
                        <td colspan="3"><span style=''><?php echo($_GET["err_code"]) ?></span></td>
                    </tr>
                <?php
                ...
                ?>
					...
					<tr>
						...
						<span class="cek_admin">Ceklist sebagai Administrator atau Kepala Kantor Arsip</span></td>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
						<td><a><input type="submit" value='LOGIN' style='width:130px;' /></a></td>
					</tr>
				</table>
			</form>	
