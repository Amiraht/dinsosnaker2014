...
<?php
    ...
    $sql_list_pegawai = "SELECT
                        ...
                        FROM
                        	...
                        	LEFT JOIN tbl_usulan_cuti e ON (a.id_pegawai = e.id_pegawai AND e.diproses=2)
                        WHERE
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">TOLAK PEGAWAI USULAN CUTI</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>TOLAK PEGAWAI USULAN CUTI</span></td>
					...
					<div class="bodypanel bodyfilter" id="bodyfilter">
						...
						$.each(list_pegawai, function(i, item){
							...
							if(item.catatan_penolakan == null){
								...
								catatan = item.catatan_penolakan;
							}
							...
							text += "<tr>";
								...
								text += "<td><button type='button' class='btn btn-sm btn-info' style='width:100%;' onclick='lihat_catatan(\"" + catatan + "\");'><span class='glyphicon glyphicon-retweet'></span>&nbsp;&nbsp;Catatan</btn></td>";
							text += "</tr>";
						});
						document.write(text);
						</script>
				...
				<div class="panelcontainer panelform" style="width: 100%;">
					<div class="bodypanel bodyfilter" id="bodyfilter">
						<table border="0px" cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td>
									<button type="button" class="btn btn-success btn-lg" onclick="kembali();"><span class='glyphicon glyphicon-chevron-left'></span>&nbsp;&nbsp;Kembali</button>
								</td>
							</tr>
						</table>
					</div>
