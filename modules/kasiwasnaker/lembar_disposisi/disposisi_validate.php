...
if($do)
	{ 
		...
		else
		{
			if($sta=='tolak')
			{
				$qca="UPDATE tbl_info_berkas SET  id_proses_skrg =  '114', id_proses_sblm =  '".$sblm."', isDisposisi =  '0' WHERE no_resi = '".$resi."'";
			}
			elseif($sta=='periksa')
			{
				$qca="UPDATE tbl_info_berkas SET  id_proses_skrg =  '113', id_proses_sblm =  '".$sblm."', isDisposisi =  '0' WHERE no_resi = '".$resi."'";
			}
			elseif($sta=='no_periksa')
			{
				$qca="UPDATE tbl_info_berkas SET  id_proses_skrg =  '141', id_proses_sblm =  '".$sblm."', isDisposisi =  '0' WHERE no_resi = '".$resi."'";
			}	
		}
		...
		if ($ca)
		{
			if($sblm=='56')
			{
				...
				<script type="text/javascript">
					alert("Berhasil");
					parent.document.location = "../../../index.php?mod=kasiwasnaker&opt=paraf_surat";
				</script>
				<?php	
			}
			elseif($sblm=='57' or $sblm=='124')
			{
				...
				<script type="text/javascript">
					alert("Berhasil");
					parent.document.location = "../../../index.php?mod=kasiwasnaker&opt=paraf_sk";
				</script>
				<?php	
			}
			elseif($sblm=='123')
			{
				...
				<script type="text/javascript">
					alert("Berhasil");
					parent.document.location = "../../../index.php?mod=kasiwasnaker&opt=penugasan";
				</script>
				<?php	
			}			
			else
			{
				...
				<script type="text/javascript">
					alert("Berhasil");
					parent.document.location = "../../../index.php?mod=kasiwasnaker&opt=cek_berkas";
				</script>
				<?php
			}
		}
