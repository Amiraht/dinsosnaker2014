...
<link rel='stylesheet' href='../../../css/button.css' type='text/css' />";
		...
		{	$perusahaan = mysql_query("
				...
				$perusahaan = mysql_query("
							SELECT
									...
									a_tbl.wnilk, a_tbl.wnipr, a_tbl.wnalk, a_tbl.wnapr, a.klui
								FROM
									db_jamsostek a
	...
	$g = mysql_query("select nama_bagian from kbli where kode_bagian='$set[21]'");
...
?>
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="2" style="font-size:12px; text-transform:uppercase">
	  <tr>
	    <td colspan="7"><br /><h2>DATA PERUSAHAAN</h2>
	      <hr /><br />
	      </td>
      </tr>
	  <tr>
	  ...
	  <tr>
	    <td colspan="7"><br /><h2>DATA KEPEMILIKAN</h2>
	      <hr />
	      <br /></td>
      </tr>
	  <tr>
	  ...
	  <tr>
	    ...
	    <td>&nbsp;</td>
	    <td>&nbsp;</td>
	    <td><input type='button' value='CETAK DATA' onCLick='' style='margin-right:5px;' /></td>
      </tr>
    </table>