...
<tr >
    <td colspan="2"><div id='header' style='background:url(./image/coba/header2.png) no-repeat; border-bottom:5px outset #0F0;'> 
      <table border="0" id='atasan'">
        	<tr>
		         <td colspan='2' style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00; href="#">PEMILIHAN TIM PEMERIKSA</a></td>
            </tr>
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
				  <img src="./image/panah.gif"  /><a href="./index.php?mod=kasipentaker&amp;opt=main" id="linkutama"> BERANDA LOGIN STAF KASI BINA PENTAKER</a> 
                 </td>
...
<tr>
	...
	<td> 
		...
		$rt = "select id_user,nama,level from user where level in('4','5','6','7','8','9')";
		$ac = mysql_query($rt);
