 <?php 
	...
	$q = "select a.*, b.keterangan, c.nama_skpd, d.jabatan,e.nama_level from user a 
			...
			LEFT JOIN tbl_ket_level e on a.level = e.id_level
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
  <tr>
     <td height="124" colspan="2"><div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
       <table border="0" id='atasan'>
        	<tr>
		         <td colspan='2' style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00;" href="#"><b>PROFIL USER</a></b></td>
            </tr>
                    <tr>
                  	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
                     <img src="./image/panah.gif" /><a href='index.php?mod=cp&opt=main' id="linkutama">BERANDA LOGIN CONTROL PANEL </a>
                     <img src="./image/panah.gif" />PROFIL USER</td>
                     </td>
            </tr>
        </table>
     </div></td>
 ...
 <td style="float:right;">
					<img width="90" height="29" 
						onclick="document.location.href='./index.php?mod=cp&opt=main'" 
...
<tr><td>&nbsp;</td></tr>
  <tr>   
	...
	<fieldset>
		...
		<br />
		<form action='index.php?mod=cp&opt=usersimpan' method='post' name='edituser'>
 ...
 <?php
	...
	echo"
      ...
      <tr height='26px'>
        <td>LEVEL USER</td>
        <td>:</td>
        <td><input id='mytext8' name='level' placeholder='' value='$set[nama_level]' readOnly='true' disabled='disable' size='29'> &nbsp;&nbsp; *Data ini tidak dapat diubah</td>
	  ...
	  <tr>
		...
		<td colspan='3'  align='center'><input type='button' id='editbtn' onclick='toggleTextbox()' value='EDIT'  align='center'> <input type='submit' id='btnsimpan' value='SIMPAN' disabled  align='center'></td>
