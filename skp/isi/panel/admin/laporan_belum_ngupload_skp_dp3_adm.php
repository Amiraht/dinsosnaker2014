...
<form name="frm" id="frm" action="cetak/cetak_laporan_belum_ngupload_skp_dp3_adm.php" method="post" target="_blank">
<div class="panelcontainer" style="width: 100%;">
    ...
    <div class="bodypanel bodyfilter" id="bodyfilter">
        ...
        <table>
            <tr>
                <td width="40%">
                    <label>Tahun SKP Dan Penilaian Prestasi Kerja Yang Belum Diupload :</label>
