...
<div class="panelcontainer panelform" style="width: 100%;">
    <h3 style="text-align: left;">EDIT SK PENINJAUAN MASA KERJA (ID Data : <?=$data['id_surat'];?>)</h3><br/>
    ...
    <div class="bodypanel bodyfilter" id="bodyfilter">
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
			...
			<tr>
                <td width='50%'>
                    <label>No Surat Usul :</label>
				
                    <input type="text" name="no_surat_usul" id="no_surat_usul" class="form-control" value="<?=$data['no_usul_pmk'];?>"/>
