        ...
        <div class="bodypanel">
            <?php
                ...
                $res_sm = mysql_query("SELECT 
                                        ...
                                        FROM 
                                            ...
                                            LEFT JOIN myapp_archivetable_suratmasuk e ON a.id = e.id_surat_masuk
                                        WHERE 
                                        	a.id='" . $_GET["id"] . "'");
            ...
            <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
                ...
                <tr>
                    ...
                    <td width='10px'>:</td>
                    <td><b><?php echo($ds_sm["sampul"]); ?></b></td>
                </tr>
                <tr>
                    <td width='20%'>Nomor Kotak</td>
                    <td width='10px'>:</td>
                    <td><b><?php echo($ds_sm["kotak"]); ?></b></td>
                </tr>
                <tr>
                    <td width='20%'>Nomor Rak</td>
                    <td width='10px'>:</td>
                    <td><b><?php echo($ds_sm["rak"]); ?></b></td>
                </tr>
            </table>
            <br />
        </div>
