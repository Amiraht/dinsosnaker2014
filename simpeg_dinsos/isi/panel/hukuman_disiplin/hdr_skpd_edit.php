					...
					<div class="bodypanel bodyfilter" id="bodyfilter">
						<table border="0px" cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td>
									<label>NO. SK</label>
									<input type="text" style='width:80%;' class="form-control" name="no_sk" id="no_sk" />
								</td>
								<td>
									<label>Tanggal SK</label>
									<input type="text"style='width:80%;' class="form-control" name="tgl_sk" id="tgl_sk" />
								</td>
							</tr>
						</table>
						<table border="0px" cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td>
									...
									<input type="text" style='width:80%;' class="form-control" name="jabatan_pejabat_sk" id="jabatan_pejabat_sk" />
								</td>
								<td>
						...
						<table border="0px" cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td>
									...
									<input type="text" style='width:80%;' class="form-control" name="nama_pejabat_sk" id="nama_pejabat_sk" />
								</td>
								<td>
									<label>NIP Pejabat Penandatangan SK</label>
									<input type="text"  style='width:80%;' class="form-control" name="nip_pejabat_sk" id="nip_pejabat_sk" />
								</td>
							</tr>
						</table>
					</div>
