...
$pos = mysql_query("select id_proses_skrg from tbl_info_berkas where no_resi='".$no_resi."'");
$posisi = mysql_fetch_array($pos);

if($posisi["id_proses_skrg"]=='54')
{
	$cek="SURAT PEMANGGILAN SUDAH AKAN DISERAHKAN";
...
{
	$cek="SURAT PEMANGGILAN SUDAH DIPARAF";
	if($sp1=='0')
	{
		$panggilan="cetak_sp1";
	}
