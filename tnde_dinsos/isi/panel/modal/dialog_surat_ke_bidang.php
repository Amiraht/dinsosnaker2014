		...
		<form name="frm" action="../../../php/posisi_surat_masuk_sekretaris.php" method="POST">
            <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
                ...
                <tr>
					...
					<td> : </td>
                    <td>
					<textarea name="catatan" placeholder=" :: JIKA SURAT MASUK DITERUSKAN KE KEPALA BADAN, TULIS CATATANNYA DISINI :: " cols='55' rows='9'>
					</textarea></td>
                </tr>
            </table><br/>
            ...
            <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
                <tr>
					<td></td>
                    <td><input type="submit" name="kabid" value='Kirim Disposisi' style="width: 100%;" /></td>
                    <td><input type="submit" name="kaban" value='Teruskan Ke Kepala Badan' style="width: 100%;" /></td>
                </tr>
                <tr>
					<td></td>
					<td></td>
