...
<fieldset>
    ...
    <form name="form1" method="post" action="../../../index.php?mod=stafkasubag_umum&opt=cetak&link=<?php echo"$no_resi"?>" target="_blank">    
...
<fieldset>
	<legend>CHECKLIST PERSYARATAN DAN KELENGKAPAN BERKAS</legend>
	 <p>
				  ...
				  BERKAS SK SUDAH DIPERIKSA<a class="menu" href="../../penomoran/cetak_sk_wl.php?link=<?php echo $no_resi;?>" target="_blank">(LIHAT SK)</a></label>
				<br>
                <label>
				  <input type="checkbox" name="berkas" value="1" id="berkas_1">
				  BERKAS SK SUDAH DINOMORI</label>
			  </p>
	<center>
    	<?php
			$onc="tolak('".$userid."')";
