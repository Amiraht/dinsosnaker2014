...
function lanjut(id_skp){
    document.location.href = "?mod=spv_skp_target_proses&id_skp=" + id_skp;
}
</script>
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">SUPERVISI SKP TARGET</a></h1>
                                </td>
                        </tr>
                        <tr>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
				...
				<div class="panelcontainer" style="width: 100%;">
					<h3 style="text-align: left;">PILIH PEGAWAI YANG AKAN DISUPERVISI</h3>
					<div class="bodypanel">
						...
						<?php
							$res = mysql_query("SELECT
												...
												WHERE
													1 AND e.id_pegawai_penilai = '" . $_SESSION["id_pegawai"] . "' AND e.status_supervisi = 1
												ORDER BY
														a.nama_pegawai ASC");
							$no = 0;
