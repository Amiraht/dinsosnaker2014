...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">PERIODE PENILAIAN PERILAKU</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>PERIODE PENILAIAN PERILAKU</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
					<fieldset>
						<h3 style="text-align: left;">DATA PERIODE PENILAIAN PERILAKU <?php echo(strtoupper(detail_pegawai($_GET["id_pegawai"], "nama_pegawai"))); ?> 
						(NIP : <?php echo(strtoupper(detail_pegawai($_GET["id_pegawai"], "nip"))); ?>)</h3><br/><br/>
							<?php
					...
					?>
					<form name="frm" id="frm" action="php/skp/perilaku_isi.php" method="post">
					...
					<div class="panelcontainer panelform" style="width: 100%;">
						...
						<div class="bodypanel bodyfilter" id="bodyfilter">
							<input type="button" value="Kembali" onclick="document.location.href='?mod=perilaku_isi_pilih_periode&id_pegawai=<?php echo($_GET["id_pegawai"]); ?>';" />
							<div class="kelang"></div>
							<table border="0px" cellspacing='0' cellpadding='0'>
								<tr>
									...
									<td width='200px'>
										<label>
											<a href="javascript:bantuan_perilaku(1);" class="link_auto_panel input_widget">Bantuan</a>
										</label>
									...
									<td width='200px'>
										<label>
											<a href="javascript:bantuan_perilaku(4);" class="link_auto_panel input_widget">Bantuan</a>
										</label>
								...
								<tr>
									...
									<td>
										<label>
											<a href="javascript:bantuan_perilaku(2);" class="link_auto_panel input_widget">Bantuan</a>
										</label>
									...
									<td>
										<label>
											<a href="javascript:bantuan_perilaku(5);" class="link_auto_panel input_widget">Bantuan</a>
										</label>
								...
								<tr>
									...
									<td>
										<label>
											<a href="javascript:bantuan_perilaku(3);" class="link_auto_panel input_widget">Bantuan</a>
										</label>
									...
									<td>
										<label>
											<a href="javascript:bantuan_perilaku(6);" class="link_auto_panel input_widget">Bantuan</a>
										</label>
