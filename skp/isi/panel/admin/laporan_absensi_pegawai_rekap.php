...
function proses(){
    ...
    var bulan = $("#bulan").val();
    if(tahun == "" )
        jAlert("Maaf, tahun absensi harus ditentukan", "PERHATIAN");
    else
        $("#frm").submit();
}
</script>
<form name="frm" id="frm" action="cetak/cetak_laporan_absensi_pegawai_rekap.php" method="post" target="_blank">
        ...
        <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
            <tr>
                ...
                <td>
                    ...
                    <?php
                        $arr_bulan = array(":: Semua bulan pada tahun yang dipilih ::", "Januari", "Februari", "Maret", "April", "Mei", "Juni", "Juli", "Agustus",
