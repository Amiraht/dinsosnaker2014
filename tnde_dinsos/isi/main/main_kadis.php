  ...
  <tr>
    <td>
        ...
        <table border="0" style="float:right; margin-top:70px; font-size:18px; font-weight:bold;">
        	<tr>
		         <td style="text-align:right; padding-right:10px; height:20px;"><a style="color:#AA9F00;" href="./?mod=main_sekretaris">BERANDA UTAMA KEPALA DINAS (KADIS)</a></td>
            </tr>
        </table>
        </div>
     </td>
   ...
   <div id='content' style='margin-left:5%;width:90%;min-height:350px;'>
	...
	<tr>
		...
		<td style="padding-left:30px;" id='menudepan'>  
        	<img src='./image/list.png'>&nbsp;<a href="./?mod=posisi_surat_masuk_kaban" class="menu">PROSES SURAT MASUK</a><br /><br />
			...
			<img src='./image/list.png'>&nbsp;<a href="./?mod=posisi_surat_keluar_kaban" class="menu">PROSES SURAT KELUAR</a><br /><br />
            <img src='./image/list.png'>&nbsp;<a href="./?mod=list_laporan_kaban" class="menu">LAPORAN-LAPORAN</a><br /><br />            
            <img src='./image/list.png'>&nbsp;<a href="./?mod=pengguna" class="menu">PROFIL USER</a><br /><br />
            <img src='./image/list.png'>&nbsp;<a href="../index.php?mod=kadis&opt=utama"  class="menu">BERANDA UTAMA</a><br /><br />
        </td>
	</tr>
	</table>
	</div>
