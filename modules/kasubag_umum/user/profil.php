...
<td style="float:right;">
  ...
  <tr>   
	...
	<fieldset>
		...
		<br />
		<form action='index.php?mod=kasubag_umum&opt=usersimpan' method='post' name='edituser'>
 ...
 <?php
	...
	echo"
	  ...
	  <tr>
		...
		<td colspan='3'  align='center'><br/><br/><input type='button' id='editbtn' onclick='toggleTextbox()' value='EDIT'>&nbsp;&nbsp; 
		<input type='button' id ='btnCancel' value='CANCEL' onclick='aktifControl()' /> &nbsp;&nbsp;
		<input type='submit' disabled id='btnsimpan' value='SIMPAN'></td>
