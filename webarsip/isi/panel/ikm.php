...
<button type="submit" style="padding: 2px 10px;" class="btn btn-success" onclick='document.location.href="?mod=mnu_ikm";'>
	KEMBALI
</button>
...
<form name="frm" action="php/ikm.php" method="post">
    <div class="panelcontainer" style="width: 100%;">
        <h3 style="text-align: left; background-color: green; color:white;">PENGISIAN INDEKS KEPUASAN MASYARAKAT</h3>
        <div class="bodypanel" id="bodyfilter">
            ...
            <table border="0px" cellspacing='0' cellpadding='0' width='50%'>
                <tr>
                    <td width='33%'><input type="submit" class="btn btn-lg btn-success" value='Simpan' style="width: 100%;"  /></td>
                    <td width='33%'><input type="reset" class="btn btn-lg btn-warning" value='Reset' style="width: 100%;" /></td>
                </tr>
            </table>
        </div>
    </div>
