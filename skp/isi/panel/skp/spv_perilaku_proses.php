        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">SUPERVISI PROSES PERILAKU</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>SUPERVISI DATA PROSES PERILAKU</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
					<div class="panelcontainer panelform" style="width: 100%;">
						...
						<?php
							$ds_skp = mysql_fetch_array(mysql_query("SELECT * FROM tbl_skp_perilaku WHERE id_skp='" . $id_skp . "'"));
						?>
						...
						<div class="kelang"></div>
						<?php
							$ds_tambahan = mysql_fetch_array(mysql_query("SELECT * FROM tbl_skp_tambahan WHERE id_skp='" . $id_skp . "'"));
						?>
						<form name="frm_tugas_tambahan" id="frm_tugas_tambahan" action="php/skp/tugas_tambahan_tambah.php" method="post">
						<div class="panelcontainer" style="width: 100%;">
							<h3 style="text-align: left;">DATA TUGAS TAMBAHAN <?php echo(strtoupper(detail_pegawai($_SESSION["id_pegawai"], "nama_pegawai"))); ?> (NIP : <?php echo(strtoupper(detail_pegawai($_SESSION["id_pegawai"], "nip"))); ?>)</h3>
							<div class="bodypanel">
						...
						<div class="panelcontainer" style="width: 100%;">
							<h3 style="text-align: left;">DATA KREATIFITAS <?php echo(strtoupper(detail_pegawai($_SESSION["id_pegawai"], "nama_pegawai"))); ?> (NIP : <?php echo(strtoupper(detail_pegawai($_SESSION["id_pegawai"], "nip"))); ?>)</h3>
							<div class="bodypanel">
							<table border="0px" cellspacing='0' cellpadding='0' width='100%' class="listingtable">
								<thead>
									<tr class="headertable">
