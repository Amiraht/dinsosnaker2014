<script type="text/javascript">
    ...
    function lanjut(id){
        document.location.href="?mod=perilaku_isi_pilih_periode&id_pegawai=" + id;
    }
</script>
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">ISI DATA PERILAKU PEGAWAI BAWAHAN</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>ISI DATA PERILAKU PEGAWAI BAWAHAN</span></td>
