      ...
      <table border="0" id='atasan'>
            ...
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
                  <img src="./image/panah.gif"  /><a href="./index.php?mod=loket&opt=laporan" id="linkutama">LAPORAN-LAPORAN</a> 
				  <img src="./image/panah.gif"  /><a href="./index.php?mod=loket&opt=lbr_kendali_lap" id="linkutama">LAPORAN LEMBAR KENDALI</a> 
...
<td style="float:right;">
					<img width="90" height="29" 
						onclick="document.location.href='./index.php?mod=loket&opt=lbr_kendali_lap'" 
...
<form action="./modules/loket/lembar_kendali/cetak_disposisi.php?link=<?php echo $resi; ?>" method="POST">
<table width="100%" class="tblisi" border="1" cellpadding="0" cellspacing="0" width="100%">
    <tr align="center">
...
?>
<tr align="center">
	<td colspan="6" align="center"><input align="middle" type="submit" value="CETAK"></td>
</tr>
</table>
</form>
</fieldset>
