...
<div class="panelcontainer" style="width: 100%;">
    ...
    <div class="bodypanel">
    <input type="button" value="Kembali" onclick="document.location.href='?mod=edit_surat_keluar&id=<?php echo($_GET["id"]); ?>';" />
    <div class="kelang"></div>
    ...
    <?php
        ...
        while($ds = mysql_fetch_array($res)){
            ...
            echo("<tr>");
                ...
                echo("</td>");
                echo("<td align='center'>");
                    echo("<img src='image/Button Next_32.png' width='18px' class='linkimage' title='Tambahkan surat ini untuk dibalas' onclick='document.location.href=\"php/cari_surat_untuk_dibalas_asli.php?id=" . $ds["id"] . "&id_surat_keluar=" . $_GET["id"] . "\"'>");
                echo("</td>");
            echo("</tr>");
        }
    ?>
