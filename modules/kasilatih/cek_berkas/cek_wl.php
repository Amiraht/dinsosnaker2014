...
<script type="text/javascript">
	...
	s='../../../index.php?mod=kasiwasnaker&opt=cek_berkas&opts=terima&value='+x+'&id_user='+uid;
		document.location.href=s;
	}

	function tolak(uid){
	var x = '<?php echo "$no_resi"; ?>';
	s='../../../index.php?mod=kasiwasnaker&opt=lembar_disposisi&opts=tolak&link='+x+'&id_user='+uid;
...
<fieldset>
	...
	<center>
        ...
        <span> BERDASARKAN HASIL PEMERIKSAAN BERKAS, MAKA PENGURUSAN WAJIB LAPOR INI :</span><br/><br/>
