...
<form name="frm" action="phpbypass/posisi_surat_keluar_kabid.php" method="post">
    <div class="panelcontainer" style="width: 100%;">
        <div class="bodypanel">
            <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
                ...
                <tr>
                    <td colspan="3"><textarea name="catatan" placeholder="CATATAN DISPOSISI" style="display: none;"></textarea></td>
                </tr>  
            </table>
