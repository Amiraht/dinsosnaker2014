...
<!-- DIALOG -->
<div id="dialog_form_disp" title="Disposisikan Surat ke Bidang">
<form name="frm" action="phpbypass/posisi_surat_masuk_sekretaris.php" method="post">
    <div class="panelcontainer" style="width: 100%;">
        <div class="bodypanel">
            <table border="0px" cellspacing='0' cellpadding='0' width='100%'>
                ...
                <?php
                    $res_ldb = mysql_query("SELECT * FROM myapp_reftable_levelpengguna WHERE (atasan='1' AND id <> 2) OR atasan='2'");
