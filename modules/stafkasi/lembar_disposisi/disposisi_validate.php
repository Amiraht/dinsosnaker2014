...
if($do)
	{ 
		...
		$qca="UPDATE tbl_info_berkas SET  id_proses_skrg =  '57', id_proses_sblm =  '".$sblm."', isDisposisi =  '0' WHERE no_resi = '".$resi."'";
		...
		if ($ca)
		{
			...
			<script type="text/javascript">
				alert("Berhasil");
				parent.document.location = "../../../index.php?mod=stafkasi&opt=cek_berkas";
			</script>
			<?php	
		}
		else {echo $qca;}
