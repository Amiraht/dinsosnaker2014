...
<fieldset>
    ...
    <form name="form1" method="post" action="../../../index.php?mod=stafkadis&opt=cetak&link=<?php echo"$no_resi"?>" target="_blank">    
	...
	<legend>CHECKLIST PERSYARATAN DAN KELENGKAPAN BERKAS</legend>
	 <p>
                ...
                <label>
				  ...
				  BERKAS SK DAN LAPORAN SUDAH DITANDA TANGAN</label>
			  </p>
	<center>
    	<?php
			$onc="tolak('".$userid."')";
