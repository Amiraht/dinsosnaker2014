...
function disposisi(id_surat_keluar, id_disposisi, no_nodin, tgl_nodin, id_ttd){
     var t = document.getElementById("div_cek_"+id_surat);
	 if(t.innerHTML != ''){
		 t.innerHTML = '';
	  }else
		t.innerHTML='<iframe src="./isi/panel/modal/dialog_posisi_sk_kaban.php?id_surat_keluar='+id_surat+'&id_disposisi='+id_disposisi+'&no_din='+no_nodin+'&tgl_din='+tgl_nodin+'" ' +
		'width="100%" style="height:1300px" frameborder="0" ' + 
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="./?mod=posisi_surat_keluar_kaban">DAFTAR SURAT KELUAR KABAN</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='<?=$url_main;?>'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>SURAT KELUAR KABAN</span>
...
<fieldset>
    <legend><h3>DAFTAR SURAT KELUAR YANG DITERIMA</h3></legend>
        ...
        while($ds = mysql_fetch_array($res)){
			...
			echo "
					<tr id='div_if'>
						...
						<td colspan='15'> <div id='div_cek_".$ds["id"]."'></div>
					</tr>
					";	
        }
    ?>
