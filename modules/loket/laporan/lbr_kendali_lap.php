...
<script type="text/javascript">
	function Kirim_Cari()
	{
		...
		var s;
		s='./index.php?mod=loket&opt=lbr_kendali_lap';
	...
	function edit_data(c,uid)
	{
			...
			if(t.innerHTML != ''){
				...
				t.innerHTML='<iframe src="./modules/loket/lembar_kendali/edit.php?link='+c+'&id_user='+uid+'" width="100%" style="height:300px" frameborder="0" scrolling="yes" id="iframe_detail"></iframe>';
	...
	{
		var s;
		s='./index.php?mod=loket&opt=lihat_kendali_lap';
		if(k != '')
		s=s+'&link='+k;
		if(uid != '')
		s=s+'&id_user='+uid;
	...
	function lihat_data(k,uid)
	{
			...
			if(t.innerHTML != ''){
				...
				t.innerHTML='<iframe src="./modules/loket/lembar_kendali/lihat.php?link='+k+'&id_user='+uid+'" width="100%" style="height:300px" frameborder="0" scrolling="yes" id="iframe_detail"></iframe>';
            ...
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
				  <a href='index.php?mod=loket&opt=laporan'> <span></span> LAPORAN-LAPORAN </a>
                     <span> </span><img src="./image/panah.gif"  /><a href="" id="linkutama">LAPORAN LEMBAR KENDALI</a> 
                 </td>
...
<tr><td>&nbsp; </td></tr>
	...
	<tr>
        ...
        <?php
		if(!empty($_GET["cari"]) and $_GET["jenis"]!='0' and $_GET["no_resi"]!='0')
				{
		...
		elseif(!empty($_GET["no_resi"]) )
				{
					$d = mysql_query("select count(*) as jumlah from tbl_info_berkas where no_resi like '%".$_GET["no_resi"]."%' ");
				}				
		elseif($_GET["jenis"]!='0' and $_GET["jenis"] != '')
				...
				echo "</span></form><br>";
		?>
    	<a href="./modules/loket/laporan/lbr_kendali_lap_cetak.php?mode=1&tgl1=<?php echo $_GET["tgl1"]; ?>&tgl2=<?php echo $_GET["tgl2"]; ?>&cari=<?php echo $_GET["cari"]; ?>&no_resi=<?php echo $_GET["no_resi"]; ?>&jenis=<?php echo $_GET["jenis"]; ?>" target="_blank" style="border:none"><img src="./image/printer.png" width="35" height="35" border="0" title="Export to Excel"/></a><br /><br />           

				<table class="tblisi" border="1" cellpadding="0" cellspacing="0" align="center" width="101%">
				<tr align="center">
				...
				<?php 
					...
					{
					$onc  = "edit_data('".$set['no_resi']."','".$_SESSION["id_user"]."')";
					$onc2 = "lihat_data('".$set['no_resi']."','".$_SESSION["id_user"]."')";
					$onc3 = "lihat_kendali('".$set['no_resi']."','".$_SESSION["id_user"]."')";
					$no=0;
					if($halaman>1)
					{
						$no=($halaman-1)*20;
