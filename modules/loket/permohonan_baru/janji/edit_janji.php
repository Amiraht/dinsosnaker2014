...
function goedit() {
		...
		document.getElementById('waktu_pkb').disabled = false;
		document.getElementById('pkb_daftar').disabled = false;
		document.getElementById('no_apindo').disabled = false;
		document.getElementById('koperasi').disabled = false;
}
...
$query=mysql_query("SELECT * FROM tbl_berkas_janji WHERE no_resi='$no_resi'");
...
echo'	<form method="post" action="./index.php?mod=loket&opt=proses_permohonan&opts=validate_janji&mode=2">
		<table name="biodata" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
					  ...
					  <tr>
						...
						<td width="20">:</td>
						<td><input name="waktu_pkb" type="text" size="40"  value="'.$result["waktu_pkb"].'"></td>
					  </tr>
					  <tr>
						<td>PKB YANG DIDAFTARKAN</td>
						<td width="20">:</td>
						<td><input name="pkb_daftar" type="text" size="40"  value="'.$result["pkb_daftar"].'"></td>
					  </tr>
					  <tr>
						<td>NOMOR ANGGOTA APINDO</td>
						<td width="20">:</td>
						<td><input name="no_apindo" type="text" size="40"  value="'.$result["no_apindo"].'"></td>
					  </tr>
					  <tr>
						<td>KOPERASI PEKERJA</td>
						<td width="20">:</td>
						<td><input name="koperasi" type="text" size="40"  value="'.$result["koperasi"].'"></td>
					  </tr>
					</table>';
}
else{
