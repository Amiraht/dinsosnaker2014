...
function tampil(c)
{
		...
		if(t.innerHTML != ''){
			...
			t.innerHTML='<iframe src="./modules/kadis/penugasan/cek.php?link='+c+'" width="100%" style="height:250px" frameborder="0" scrolling="no" id="iframe_detail"></iframe>';
				...
				if(isset($_POST["cari"]))
					{
					...
					else
						{
							$query = mysql_query("SELECT
											...
											WHERE		
												(a.id_proses_skrg = '311' OR a.id_proses_skrg = '112') AND a.isDisposisi = '0'
											LIMIT ".$posisi.",".$batas."");
						}
...
<?php
		...
		if($_GET["opts"] == 'proses')
			include('./modules/kadis/penugasan/proses.php');
		else
