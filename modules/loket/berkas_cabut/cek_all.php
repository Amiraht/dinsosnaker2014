...
<script type="text/javascript">
	...
	s='../../../index.php?mod=loket&opt=berkas_cabut&opts=terima2&value='+x;
		document.location.href=s;
	}
	function tolak(){
	var w = '<?php echo "$no_resi"; ?>';
	g='../../../index.php?mod=loket&opt=berkas_cabut&opts=tolak&value='+w;
	...
	<legend>KELENGKAPAN BERKAS YANG AKAN DISERAHKAN</legend>
	   <p>
		<label>
		  ...
		  PEMOHON TELAH MENGISI DAN MENANDATANGI BUKU TANDA BUKTI PENYERAHAN BERKAS CABUT PERKARA</label>
		<br>
		<label>
