...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
  <tr>
     <td height="124" colspan="2"><div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
       <table border="0" id='atasan'>
        	<tr>
		         <td colspan='2' style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00;" href="#">PROFIL USER</a></td>
            </tr>
                    <tr>
                  	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='index.php?mod=sekretaris&opt=main'>BERANDA LOGIN SEKRETARIS </a>
                     <span> </span> <img src="./image/panah.gif" /> <a href="#" id="linkutama"> PROFIL USER</a>
                     </td>
  ...
  <tr>
	...
	<fieldset>
		...
		<br />
		<form action='index.php?mod=loket&opt=usersimpan' method='post' name='edituser'>
