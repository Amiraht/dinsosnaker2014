...
$q1 = mysql_query("select * from tbl_berita where id_berita='".$_GET["id_berita"]."'");
$q11 = mysql_fetch_array($q1);
	
?>

<fieldset style="margin:10px"><legend style="font-family:verdana; font-size:12px;"><b>Edit Berita dan Informasi</b></legend>
<form action="../../../../index.php?mod=cp&opt=berita_informasi&opts=validasi&optss=edit&id_berita=<?php echo $_GET["id_berita"]; ?>" method="post" name="fedit" enctype="multipart/form-data">
