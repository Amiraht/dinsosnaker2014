<?php
	$id_sk = mysql_real_escape_string(trim(strip_tags($_GET["id_sk"])));
?>
<!-- CONTROLLER -->
...
<?php
    ...
    $sql_daftar = "SELECT
                        ...
                        i.id_detail_gaji_berkala, i.status
                    FROM
                    	tbl_pegawai a
                    	...
                    	INNER JOIN tbl_usulan_gaji_berkala_detail i ON (a.id_pegawai = i.id_pegawai AND i.id_sk = '" . $id_sk . "')
                    ORDER BY
...
<script type="text/javascript">
    ...
    function hapus(id_detail_gaji_berkala){
        jConfirm("Anda yakin akan menghapus data ini?", "PERHATIAN", function(r){
            if(r){
                var id_sk = <?php echo($_GET["id_sk"]); ?>;
                document.location.href="php/gaji_berkala/gb_daftar_sk_diusulkan_pop.php?id_sk=" + id_sk + "&id_detail_gaji_berkala=" + id_detail_gaji_berkala;
            }
        });
    }
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">DAFTAR PEGAWAI YANG DIUSULKAN</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>DAFTAR PEGAWAI PADA SK KENAIKAN GAJI BERKALA</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
			<div class="panelcontainer" style="width: 100%;">
				...
				<div class="bodypanel">
					<button type="button" class="btn btn-success" onclick="document.location.href='?mod=gb_daftar_sk_diusulkan_push&id_sk=<?php echo($_GET["id_sk"]); ?>';"><span class='glyphicon glyphicon-tags'></span>&nbsp;&nbsp;Tambah dari Usulan SKPD</button>
