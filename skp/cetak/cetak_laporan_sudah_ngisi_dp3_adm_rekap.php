     ...
     $sql = "SELECT
            ...
            FROM
            	(
            		...
            		FROM
            			tbl_pegawai a
            			LEFT JOIN tbl_skp_perilaku b ON (a.id_pegawai = b.id_pegawai AND YEAR(b.dari) = '" . $_POST["tahun"] . "' AND b.orientasi_pelayanan IS NOT NULL)
...
<?php
    ...
    if($_POST["kode_skpd"] != "all"){
        ...
        while($ds = mysql_fetch_array($res)){
            ...
            if(($no - 1) % 30 == 0){
                $html .= "<h3 style='text-align: center;'>REKAPITULASI PENGISIAN PENILAIAN PRESTASI KERJA " . strtoupper($nama_skpd . " TAHUN " . $_POST["tahun"]) . "</h3>";
