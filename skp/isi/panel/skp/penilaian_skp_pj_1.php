<script type="text/javascript">
    ...
    function lanjut(id){
        document.location.href="php/set_pegawai.php?id=" + id + "&mod=penilaian_skp_target";
    }
</script>
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">PENILAIAN SKP PEGAWAI</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>PENILAIAN SKP PEGAWAI</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
			...
			<fieldset id="bodyfilter">
				<h3>FILTER DATA PENCARIAN</h3><br/><br/>
			...
			<br/><br/>
			<fieldset>
				<h3 style="text-align: left;">DAFTAR PEGAWAI DI SKPD <?php echo(strtoupper(nama_skpd($_SESSION["id_skpd"]))); ?></h3><br/><br/>
				<table border="0px" cellspacing='0' cellpadding='0' width='100%' class="listingtable">
					...
					?>
						<tr>
							...
							<td>
								<img src='image/Text-Signature-32.png' width='18px' class='linkimage' title='Lanjut Untuk Memanajemen Data Penilaian SKP Pegawai' onclick='lanjut(<?php echo($ds["id_pegawai"]); ?>);' />
							</td>
						</tr>
					<?php
						}
