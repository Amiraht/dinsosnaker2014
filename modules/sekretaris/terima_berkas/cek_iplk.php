...
<fieldset>
	...
	<table name="biodata" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>NAMA PEMOHON</td>
        <td width="20">:</td>
        <td><?=$da['nama_pemohon'];?></td>
        </td>
      </tr>	
      <tr>
        <td>ALAMAT PEMOHON</td>
        <td width="20">:</td>
        <td><?=$da['alamat_pemohon'];?></td>
        </td>
      </tr>						  	
      <tr>
        <td>NAMA LEMBAGA</td>
        <td width="20">:</td>
        <td><?=$da['nama_lembaga'];?></td>
      </tr>
      <tr>
        <td>NO. AKTE</td>
        <td width="20">:</td>
      ...
      <tr>
        ...
        <td width="20">:</td>
        <td><?=$da['nama_penanggung_jawab'];?></td>
      </tr>     
      <tr>
        <td>BENTUK USAHA</td>
        <td width="20">:</td>
        <td><?=$da['bentuk_usaha'];?></td>
      </tr>       
      <tr>
      ...
      <tr>
        <td>SUMBER BIAYA</td>
        <td width="20">:</td>
        <td><?=$da['sumber_biaya'];?></td>
      </tr>
      <tr>
        <td>SIFAT PERMOHONAN</td>
        <td width="20">:</td>
        <td><?=strtoupper($da['sifat']);?></td>
      </tr>      
	</table>
</fieldset>
<fieldset>
