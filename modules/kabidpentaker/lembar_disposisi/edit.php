...
$sta= $_GET["opts"]; 
$b = mysql_query("select id_proses_skrg,mediator,catatan from tbl_info_berkas where no_resi = '$resi'");
$bz = mysql_fetch_array($b);
if($bz[0]=='45')
{
	if($sta=='terima')
	{
		$qry="select id_pengguna,id_proses_lanjutan from tbl_alur_baru where id_proses = '".$bz[0]."' and id_pengguna='8'";
	}
	else
	{
...
<form action="./modules/kabidpentaker/lembar_disposisi/disposisi_validate.php?link=<?php echo $resi; ?>&id_user=<?php echo $userid; ?>" method="POST">
<table>
<tr>
	<td>DISPOSISI
...
<tr valign="top">
	...
	<td width = "40"> :
	<td>
		<textarea name="catatan" cols="40" rows="7" style="font-family:verdana;font-size:12px"><?php echo $bz[2];?></textarea>
</tr>
<tr>
	<td></td>
	<td></td>
