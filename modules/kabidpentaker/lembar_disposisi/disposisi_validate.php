...
if($do)
	{ 
		if($tujuan_level=='8')
			{
				$qca="UPDATE tbl_info_berkas SET  id_proses_skrg =  '55', id_proses_sblm =  '".$sblm."', isDisposisi =  '0' WHERE no_resi = '".$resi."'";
			}
		...
		else if($tujuan_level=='16')
			{
				if($sblm=='46')
				{
					$qca="UPDATE tbl_info_berkas SET  id_proses_skrg =  '76', id_proses_sblm =  '".$sblm."', isDisposisi =  '0' WHERE no_resi = '".$resi."'";
				}
				else
				{
					$qca="UPDATE tbl_info_berkas SET  id_proses_skrg =  '73', id_proses_sblm =  '".$sblm."', isDisposisi =  '0' WHERE no_resi = '".$resi."'";
				}
			}
		...
		if ($ca)
		{
			if($sblm=='46')
			{
				...
				<script type="text/javascript">
					alert("Berhasil");
					parent.document.location = "../../../index.php?mod=kabidpentaker&opt=paraf_surat";
				</script>
				<?php
			}
			if($sblm=='47')
			{
				...
				<script type="text/javascript">
					alert("Berhasil");
					parent.document.location = "../../../index.php?mod=kabidpentaker&opt=paraf_imta";
				</script>
				<?php
			}
			if($sblm=='48')
			{
				...
				<script type="text/javascript">
					alert("Berhasil");
					parent.document.location = "../../../index.php?mod=kabidpentaker&opt=berkas_tolak";
				</script>
				<?php
			}			
			else
			{
				...
				<script type="text/javascript">
					alert("Berhasil");
					parent.document.location = "../../../index.php?mod=kabidpentaker&opt=verifikasi_berkas";
				</script>
				<?php
			}
		}
