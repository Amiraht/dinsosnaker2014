...
// untuk surat keluar
function lihat_detail_sk(id_surat, id_disposisi){
	 var t = document.getElementById("div_cek_"+id_surat);
	 if(t.innerHTML != ''){
		 t.innerHTML = '';
	  }else
		t.innerHTML='<iframe src="./ajax/detail_sk.php?id='+id_surat+'&id_disposisi='+id_disposisi+'" width="100%" style="height:600px" frameborder="0" scrolling="yes"' + 
		'scrolling="no" id="iframe_detail"></iframe>';	
		
}	

function lihat_cadis_sk(id_surat, id_disposisi){
	 var t = document.getElementById("div_cek_"+id_surat);
	 if(t.innerHTML != ''){
		 t.innerHTML = '';
	  }else
		t.innerHTML='<iframe src="./ajax/cadis_sk_feed.php?id='+id_surat+'&id_disposisi='+id_disposisi+'" width="100%" style="height:600px" frameborder="0" scrolling="yes"' + 
		'scrolling="no" id="iframe_detail"></iframe>';	
		
}

function lihat_file_sk(id_surat, id_disposisi){
	 var t = document.getElementById("div_cek_"+id_surat);
	 if(t.innerHTML != ''){
		 t.innerHTML = '';
	  }else
		t.innerHTML='<iframe src="./ajax/file_sk_feed.php?id='+id_surat+'&id_disposisi='+id_disposisi+'" width="100%" style="height:600px" frameborder="0" scrolling="yes" ' + 
		'scrolling="no" id="iframe_detail"></iframe>';	
