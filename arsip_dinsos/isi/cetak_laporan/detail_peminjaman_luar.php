...
<?php
    ...
    <div class='panelcontainer' style='width: 100%;'>
        <h3 style='text-transform: uppercase;'>DETAIL PEMINJAMAN LUAR</h3>
        <div class='bodypanel'>
    ...
    $whr = "";
            ...
            while($ds = mysql_fetch_array($res)){
                ...
                <tr>
                    <td width='200px' style='border-bottom: solid 0px #CCC; text-transform: uppercase; font-weight: bold'>Tanggal Jatuh Tempo</td>
                    <td align='center' width='5px' style='border-bottom: solid 0px #CCC;'>:</td>
                    <td style='border-bottom: solid 1px #CCC; text-transform: capitalize; font-style: italic;'>$ds[tgl_jatuh_tempo]</td>
                </tr>
                <tr>
                    <td width='200px' style='border-bottom: solid 0px #CCC; text-transform: uppercase; font-weight: bold'>Status Dokumen</td>
                    <td align='center' width='5px' style='border-bottom: solid 0px #CCC;'>:</td>
                    <td style='border-bottom: solid 1px #CCC; text-transform: capitalize; font-style: italic;'>$ds[status_dokumen]</td>
                </tr>
                <tr>
