...
<script type="text/javascript">
	...
	s='../../../index.php?mod=stafkasihubsaker&opt=lembar_disposisi&link='+x+'&id_user='+uid;
...
<fieldset>
    ...
    <form name="form1" method="post" action="../../../index.php?mod=stafkasihubsaker&opt=cetak&link=<?php echo"$no_resi"?>" target="_blank">
...
<fieldset>  
		<center>
         <?php
			...
			$onc="terima('".$userid."')";
		?>		
		<input type="submit" onclick="CekAll()" value="PRINT SK PKB">
