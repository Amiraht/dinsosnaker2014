...
function goedit() {
	...
	function kirim_edit()
	{
		...
		var s;
		s='./index.php?mod=loket&opt=proses_permohonan&opts=edit_janji';
		if(no_resi != '')
		s=s+'&no_resi='+no_resi;
		document.location.href=s;
	} 
		...
		<table name="biodata" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
					  ...
					  <tr>
						...
						<td width="20">:</td>
						<td><input name="waktu_pkb" type="text" size="40" disabled value="'.$result["waktu_pkb"].'"></td>
					  </tr>
					  <tr>
						<td>PKB YANG DIDAFTARKAN</td>
						<td width="20">:</td>
						<td><input name="pkb_daftar" type="text" size="40" disabled value="'.$result["pkb_daftar"].'"></td>
					  </tr>
					  <tr>
						<td>NOMOR ANGGOTA APINDO</td>
						<td width="20">:</td>
						<td><input name="no_apindo" type="text" size="40" disabled value="'.$result["no_apindo"].'"></td>
					  </tr>
					  <tr>
						<td>KOPERASI PEKERJA</td>
						<td width="20">:</td>
						<td><input name="koperasi" type="text" size="40" disabled value="'.$result["koperasi"].'"></td>
					  </tr>
					</table>';
}
else{
