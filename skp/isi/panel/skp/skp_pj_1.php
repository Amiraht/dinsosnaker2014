...
<script type="text/javascript">
    ...
    function lanjut(id){
        document.location.href="php/set_pegawai.php?id=" + id + "&mod=skp_target";
    }
</script>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
			<form name="frm" action="?mod=<?php echo($_GET["mod"]); ?>" method="post">
				...
				<div class="kelang"></div>
				<div class="panelcontainer" style="width: 100%;">
					<h3 style="text-align: left;">DAFTAR PEGAWAI DI SKPD <?php echo(strtoupper(nama_skpd($_SESSION["simpeg_id_skpd"]))); ?></h3>
					<div class="bodypanel">
					<table border="0px" cellspacing='0' cellpadding='0' width='100%' class="listingtable">
						...
						$nip = isset($_POST["nip"]) ? $_POST["nip"] : "";	
							...
							$res = mysql_query("SELECT
												...
												WHERE
													(a.id_status_kepegawaian = 1 OR a.id_status_kepegawaian = 4) AND a.id_satuan_organisasi='" . $_SESSION["simpeg_id_skpd"] . "'
													" . $whr . "
												ORDER BY
													a.nama_pegawai");
							$no = 0;
						...
						?>
							<tr>
								...
								<td>
									<img src='image/Text-Signature-32.png' width='18px' class='linkimage' title='Lanjut Untuk Memanajemen Data SKP Pegawai' onclick='lanjut(<?php echo($ds["id_pegawai"]); ?>);' />
								</td>
							</tr>
						<?php
							}
