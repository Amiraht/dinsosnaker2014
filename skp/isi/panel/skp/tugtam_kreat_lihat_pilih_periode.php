...
function lanjut(id){
    document.location.href="?mod=tugtam_kreat_lihat&id_skp=" + id + "&id_pegawai=<?php echo($_GET["id_pegawai"]); ?>";
}
</script>
<div class="panelcontainer" style="width: 100%;">
    <h3 style="text-align: left;">DATA PERIODE PENILAIAN PEGAWAI <?php echo(strtoupper(detail_pegawai($_GET["id_pegawai"], "nama_pegawai"))); ?> (NIP : <?php echo(strtoupper(detail_pegawai($_GET["id_pegawai"], "nip"))); ?>)</h3>
    <div class="bodypanel">
        <input type="button" value="Kembali" onclick="document.location.href='?mod=tugtam_kreat_lihat_pilih_bawahan';" />
