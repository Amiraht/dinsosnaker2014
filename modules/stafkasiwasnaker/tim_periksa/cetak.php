<?php
	...
	$atas = '<table border="0" width="100%" align="center">
			...
			<tr>
				<td colspan="2" align="center">Nomor : ____ /____ /DSTKM/____</td>
			</tr>
			</table>
			<br/><br/>
	...
	$bawah= '
			...
			<tr>
			 ...
			 <tr>
				<td width="80" align="left"></td>
				<td width="20" align="left">3. </td>
				<td width="400" align="left">Surat Perintah Tugas ini berlaku : Bulan ...... s/d ...... ......</td>
			 </tr>
			 <tr>
				<td width="80" align="left"></td>
				<td width="20" align="left">4. </td>
			...
			<tr>
				<td width="15%" align="left"></td>
				<td width="30%" align="left"></td>
				<td width="50%" align="left">Pada Tanggal : </td>
			</tr>
			<tr>
				<td width="15%" align="left"></td>
				<td width="30%" align="left"></td>
