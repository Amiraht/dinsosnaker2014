<?php
	...
	$html = '<table border="0" width="100%" align="center">
			...
			<tr>
				...
				<td width="55%" align="left">: <u>Panggilan II</u></td>
...
<p>Berdasarkan Undang-Undang No. 13 Tahun 2003 dan Undang-Undang No. 2 Tahun 2004, sehubungan dengan surat panggilan I Kepala Dinas Sosial dan Tenaga Kerja Kota Medan No. '.$no_surat1.' tanggal '. tgl_indo($tgl_surat1).' untuk berunding tanggal '.tgl_indo($tgl_h1).' perihal '.$masalah.' dari '.$per.' maka untuk penyelesaian masalah tersebut diminta kehadiran saudara pada : 
			</p>
