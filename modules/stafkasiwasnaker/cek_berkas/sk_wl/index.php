...
$no_resi = $_GET["link"]; 
$qry="select * from tbl_sk_wl where no_resi = '$no_resi'";
$cz = mysql_query($qry);
...
<tr valign="top">
	<td>LAMPIRAN</td>
	<td>:</td>
	<td><input name="lampiran" type="text" size="60" value="<?php echo $dt["lampiran"];?>"></td>
</tr>
<tr valign="top">
	<td>HAL</td>
	<td>:</td>
	<td><input name="hal" type="text" size="60" value="<?php echo $dt["hal"];?>"></td>
</tr>
<tr valign="top">
...
<tr valign="top">
	<td>NO. URUT</td>
	<td>:</td>
	<td><input name="urut" type="text" size="60" value="<?php echo $dt["urut"];?>"></td>
</tr>
<tr valign="top">
	<td>BERLAKU MULAI</td>
	<td>:</td>
