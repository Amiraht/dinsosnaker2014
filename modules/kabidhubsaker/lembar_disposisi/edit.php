...
$b = mysql_query("select id_proses_skrg,mediator from tbl_info_berkas where no_resi = '$resi'");
...
if($id_proses=='43')
{
	if($sta=='terima')
	{
		$qry="select id_pengguna,id_proses_lanjutan from tbl_alur_baru where id_proses = '".$bz[0]."' and id_pengguna='16'";
	}
	else
	{
		$qry="select id_pengguna,id_proses_lanjutan from tbl_alur_baru where id_proses = '".$bz[0]."' and id_pengguna='5'";
	}
}
elseif($id_proses=='410')
{
	if($sta=='tolak')
	{
	...
	{
		$qry="select id_pengguna,id_proses_lanjutan from tbl_alur_baru where id_proses = '".$bz[0]."' and id_pengguna='20'";
	}
}
else
{
      ...
      <table border="0" id='atasan'>
            ...
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
                  ...
                  <!--<img src="./image/panah.gif"  /><a href="./index.php?mod=kabidhubsaker&opt=verifikasi_berkas" id="linkutama">PROSES MEDIASI DAN MEMILIH MEDIATOR</a> -->
...
<td style="float:right;">
					<img width="90" height="29" 
						onclick="document.location.href='./index.php?mod=kabidhubsaker&opt=verifikasi_berkas'" 
...
<fieldset >
	<legend>LEMBAR DISPOSISI</legend><br/>
...
<form action="./modules/kabidhubsaker/lembar_disposisi/disposisi_validate.php?link=<?php echo $resi; ?>&id_user=<?php echo $userid; ?>" method="POST">
<table>
<tr>
	<td>DISPOSISI
	<td > :<input type="hidden" name="sblm" value=<?php echo $bz[0];?> />
	<td> 
		<select name="tujuan">
		<?php
