...
<input type="button" value="Selesai" style="padding: 5px 20px; text-transform: uppercase;" class="btn btn-success" onclick="document.location.href='?mod=pin_dig';" />
<input type="button" value="Batalkan Peminjaman" style="padding: 5px 20px; text-transform: uppercase;" class="btn btn-info" onclick="batal();" />
