...
<script type="text/javascript" src="./libraries/arsip.js"></script>
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">LAPORAN ARSIP CETAK KOTAK SAMPUL</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <a href='./?mod=laporan_arsip_cetak_kotak_sampul'> <span>LAPORAN ARSIP CETAK KOTAK SAMPUL</span>
								 </a></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
						...
						<table border="0px" cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								...
								<td>
									...
									<?php
										$res_skpd = mysqli_query($con, "SELECT * FROM ref_masalah ORDER BY id_masalah ASC");
										while($ds_skpd = mysqli_fetch_array($res_skpd)){
							...
							<tr>
								...
								<td>
									...
									<?php
										$res_skpd = mysqli_query($con, "SELECT * FROM ref_keterangan_benda_arsip ORDER BY id_keterangan_benda_arsip ASC");
										while($ds_skpd = mysqli_fetch_array($res_skpd)){
				...
				<br/><br>
			<fieldset>
				<h3>DAFTAR DATA ARSIP</h3><br/><br/>
				<input type="button" value="Cetak Informasi Kotak" onclick="window.open('?mod=cetak_kotak');" />
				<br/><br/>
