...
if($do)
	{ 
		...
		if($tujuan_level=='12')
		{
			$qca="UPDATE tbl_info_berkas SET  id_proses_skrg =  '122', id_proses_sblm =  '".$sblm."', isDisposisi =  '0' WHERE no_resi = '".$resi."'";
		}
		else
		{
		...
		if ($ca)
		{
			...
			<script type="text/javascript">
				alert("Berhasil");
				parent.document.location = "../../../index.php?mod=pengawas&opt=hasil_lap";
			</script>
			<?php	
		}
		else {echo $qca;}
