            ...
            FROM
            	(
            		...
            		FROM
            			...
            			LEFT JOIN tbl_uraian_realisasi_skp d ON (b.id_skp = d.id_skp AND d.bulan = " . $_POST["bulan"] . ")
...
<?php
    ...
    if($_POST["kode_skpd"] != "all"){
        ...
        while($ds = mysql_fetch_array($res)){
            ...
            if(($no - 1) % 30 == 0){
                $html .= "<h3 style='text-align: center;'>REKAPITULASI PENGISIAN SKP " . strtoupper($nama_skpd) . " BULAN " . strtoupper($arr_bulan[$_POST["bulan"]] . " " . $_POST["tahun"]) . "</h3>";
                $html .= "<table width='100%' border='1px' cellspacing='0' cellpadding='5' style='border-collapse: collapse; font-family: sans-serif; font-size: 9pt; page-break-after: always'>";
                    ...
                    $html .= "</tr>";
            }else if(($no - 1) % 30 == 29 || $no == $jlh_satu){
                $html .= "<tr>";
                        $html .= "<td align='center'>" . $no . "</td>";
                        $html .= "<td align='left'>" . strtoupper($ds["skpd"]) . "</td>";
                        $html .= "<td align='center'>" . $ds["belum_isi"] . "</td>";
