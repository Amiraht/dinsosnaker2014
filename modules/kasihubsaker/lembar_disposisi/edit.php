...
if($sblm=='151')
	{
		if($sta=='no_periksa')
		{
			$qry="select id_pengguna,id_proses_lanjutan from tbl_alur_baru where id_proses = '".$bz[0]."' and id_pengguna='21'";
		}
		elseif($sta=='tolak')
		{
...
<fieldset style='width:90%; margin-left:40px; padding-left:20px;min-height:40px; margin-bottom:10px;padding-right:20px;'>
    ...
    <br />
    <br />     
<form action="./modules/kasihubsaker/lembar_disposisi/disposisi_validate.php?link=<?php echo $resi; ?>&id_user=<?php echo $userid; ?>&status=<?php echo $sta; ?>" method="POST">
<table>
<tr>
	<td>DISPOSISI
