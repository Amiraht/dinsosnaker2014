  ...
  <tr>
     <td colspan="2"><div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
       <table border="0" id='atasan'>
        	<tr>
		         <td colspan="2" style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00;" href="#">DATA POTENSIAL</a> </td>
            </tr
                    ><tr>
  ...
  <tr><td></td></tr>
    <td colspan="2">
        ...
        <br>
			...
			echo '</span></form><span style="float:right;">'; //<a href="./modules/jamsos/data_potensial/print_excel.php" >Cetak</a><br><br><br>';
							...
							if(mysql_num_rows($result) > 0)
							{
								...
								while($row = mysql_fetch_array($result))
									...
									echo "<tr>
										...
										<td>$row[3]</td>
										<td>$row[6]</td>
										<td width='50px'><a href='javascript:lihat_detail($row[0],\"$row[6]\");'>DETAIL </a></td>
									</tr>
									<tr>
