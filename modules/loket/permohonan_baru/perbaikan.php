        	...
        	<tr>
				 ...
				 PROSES PENGURUSAN PENGADUAN KETENAGAKERJAAN</a></td>
                        ...
                        <tr>
                            ...
                            <td><img  align="right" width="90" height="29" onclick="document.location.href='./index.php?mod=loket&opt=proses_permohonan&opts=baru'" 
...
<fieldset>
		<legend>CHECKLIST PERSYARATAN DAN KELENGKAPAN BERKAS</legend>
			  <p>
				...
				<CENTER><input type="button" onClick="CekAll()" value="CENTANG SEMUA"> <input type="submit" value="SIMPAN"></CENTER>				
			  </form>
</fieldset>
</table>';
}
