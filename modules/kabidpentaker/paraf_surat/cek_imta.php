...
<script type="text/javascript">
	...
	s='../../../index.php?mod=kabidpentaker&opt=lembar_disposisi&opts=terima&link='+x+'&id_user='+uid;
		parent.document.location.href=s;
	}
	function tolak(uid){
	var w = '<?php echo "$no_resi"; ?>';
	g='../../../index.php?mod=kabidpentaker&opt=lembar_disposisi&opts=tolak&link='+w+'&id_user='+uid;
	...
	<legend>CHECKLIST PERSYARATAN DAN KELENGKAPAN SURAT</legend>
	 <p>
				...
				<label>
				  ...
				  BERKAS DRAFT SK PENUGASAN SUDAH DIPARAF</label>
				<br>
			  </p>
	<center>
    	<?php
