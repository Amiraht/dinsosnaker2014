...
<?php
            $ds_header = mysql_fetch_array(mysql_query("SELECT
                                    ...
                                    CASE
                                		WHEN b.gelar_depan <> '' AND b.gelar_depan IS NOT NULL THEN CONCAT(b.gelar_depan, '. ')
                                		ELSE ''
                                	END AS geldep_penilai,
                                	CASE
                                		WHEN c.gelar_depan <> '' AND c.gelar_depan IS NOT NULL THEN CONCAT(c.gelar_depan, '. ')
                                		ELSE ''
                                	END AS geldep_atasan_penilai,
                                	CASE
                                		WHEN bc.gelar_depan <> '' AND bc.gelar_depan IS NOT NULL THEN CONCAT(bc.gelar_depan, '. ')
                                		ELSE ''
                                	END AS geldep_pegawai,
                                	CASE
                                		WHEN b.gelar_belakang <> '' AND b.gelar_belakang IS NOT NULL THEN CONCAT(', ', b.gelar_belakang)
                                		ELSE ''
                                	END AS gelbel_penilai,
                                	CASE
                                		WHEN c.gelar_belakang <> '' AND c.gelar_belakang IS NOT NULL THEN CONCAT(', ', c.gelar_belakang)
                                		ELSE ''
                                	END AS gelbel_atasan_penilai,
                                	CASE
                                		WHEN bc.gelar_belakang <> '' AND bc.gelar_belakang IS NOT NULL THEN CONCAT(', ', bc.gelar_belakang)
                                		ELSE ''
                                	END AS gelbel_pegawai
                                FROM
                                	tbl_skp_perilaku a
                                ...
                                WHERE
                                	a.id_skp_perilaku='" . $_GET["id_skp"] . "'
                                ORDER BY
                                	a.dari ASC
                                "));
            $gelar_depan_penilai = $ds_header["geldep_penilai"];
            $gelar_depan_atasan_penilai = $ds_header["geldep_atasan_penilai"];
            $gelar_depan_pegawai = $ds_header["geldep_pegawai"];
            $gelar_belakang_penilai = $ds_header["gelbel_penilai"];
            $gelar_belakang_atasan_penilai = $ds_header["gelbel_atasan_penilai"];
            $gelar_belakang_pegawai = $ds_header["gelbel_pegawai"];
        ?>
<?php
    $html = "";
    $html .= "<html>";
    ...
    $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt; page-break-after: always'>";
        $html .= "<tr>";
                ...
                $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt;'>";
                    ...
                    $html .= "<tr>";
                        $html .= "<td style='border: solid 1px #000000;' colspan='4' align='left'>
                            ...
                            <div style='text-align:right;'>(" . $gelar_depan_penilai . $ds_header["nama_pegawai_penilai"] . $gelar_belakang_penilai . ")</div>
                    ...
                    $html .= "<tr>";
                        $html .= "<td style='border: solid 1px #000000;' colspan='4' align='left'>
                            ...
                            <div style='text-align:left; height:100px;'></div>
                            <div style='text-align:left;'>(" . $gelar_depan_pegawai . $ds_header["nama_pegawai"] . $gelar_belakang_pegawai . ")</div>
                    ...
                    $html .= "<tr>";
                        $html .= "<td style='border: solid 1px #000000;' colspan='4' align='left'>
                            ...
                            <div style='text-align:right; height:100px;'></div>
                            <div style='text-align:right;'>(" . $gelar_depan_atasan_penilai . $ds_header["nama_pegawai_atasan_penilai"] . $gelar_belakang_atasan_penilai . ")</div>
            ...
            $html .= "<td width='50%' valign='top'>";
                ...
                $html .= "<div style='text-align: center;'>";
                    $html .= "<img src='../image/garuda.png' width='70px' style='border: solid 0px black;' />";
                $html .= "</div>";
                $html .= "<div style='text-align: center'><h3>PENILAIAN PRESTASI KERJA<br />PEGAWAI NEGERI SIPIL</h3></div>";
                $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt;'>";
                    $html .= "<tr>";
                        $html .= "<td width='50%' align='left'>" . strtoupper($ds_header["skpd"]) . "</td>";
                        $html .= "<td width='50%' align='right'>JANGKA WAKTU PENILAIAN<br />" . tglindonesia($ds_header["dari"]) . " S/D " . tglindonesia($ds_header["sampai"]) . "</td>";
                    $html .= "</tr>";
                $html .= "</table>";
                $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt;'>";
                    $html .= "<tr>";
                    ...
                    $html .= "<tr>";
                        ...
                        $html .= "<td style='border: solid 1px #000000;'>" . $gelar_depan_pegawai . $ds_header["nama_pegawai"] . $gelar_belakang_pegawai . "</td>";
                    $html .= "</tr>";
                    $html .= "<tr>";            
                ...
                $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt;'>";
                    ...
                    $html .= "<tr>";
                        $html .= "<td style='border: solid 1px #000000;' width='30%'>Nama</td>";
                        $html .= "<td style='border: solid 1px #000000;'>" . $gelar_depan_penilai . $ds_header["nama_pegawai_penilai"] . $gelar_belakang_penilai . "</td>";
                    $html .= "</tr>";
                    $html .= "<tr>";            
                        $html .= "<td style='border: solid 1px #000000;'>NIP</td>";
                ...
                $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt;'>";
                    ...
                    $html .= "<tr>";
                        $html .= "<td style='border: solid 1px #000000;' width='30%'>Nama</td>";
                        $html .= "<td style='border: solid 1px #000000;'>" . $gelar_depan_atasan_penilai . $ds_header["nama_pegawai_atasan_penilai"] . $gelar_belakang_atasan_penilai . "</td>";
                    $html .= "</tr>";
                    $html .= "<tr>";            
                        $html .= "<td style='border: solid 1px #000000;'>NIP</td>";
                ...
                $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt;'>";
                    ...
                    $ds_perilaku = mysql_fetch_array(mysql_query("SELECT *, 
                                                            ...
                                                            FROM 
                                                            	tbl_skp_perilaku 
                                                            WHERE 
                                                            	id_skp_perilaku='" . $_GET["id_skp"] . "'"));
                    $bagi = 6;
                    if($ds_perilaku["kepemimpinan"] == 0)
                        $bagi = 5;
                    $rata = $ds_perilaku["total"] / $bagi;
                    $nilai_perilaku_kerja = ($rata * 40) / 100;
                    // -----------------------------------------------------------------------------------------
                    $html .= "<tr>";
                    ...
                    $html .= "<tr>";
                        ...
                        if($ds_perilaku["kepemimpinan"] > 0){
                            ...
                            $html .= "<td style='border: solid 1px #000000;' align='center'>-</td>";
                            $html .= "<td style='border: solid 1px #000000;' align='center'>-</td>";
                        }
                    ...
                    $html .= "<tr>";
                        ...
                        $html .= "<td style='border: solid 1px #000000;' align='center'>" . number_format($rata, 2) . "</td>";
                        $html .= "<td style='border: solid 1px #000000;'>&nbsp;</td>";
                ...
                $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt;'>";
                    $html .= "<tr>";
                        $html .= "<td style='border: solid 1px #000000;' colspan='4' align='left'>
                            ...
                            <div style='height:250px;'>" . $ds_perilaku["keberatan"] . "</div>
                            <div style='height:10px;'>&nbsp;</div>
                            <div><i>Tanggal,</i></div>
                        </td>";
                    $html .= "</tr>";
                ...
                $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt;'>";
                    $html .= "<tr>";
                        $html .= "<td style='border: solid 1px #000000;' colspan='4' align='left'>
                            ...
                            <div style='height:10px;'>&nbsp;</div>
                            <div style='height:280px;'>" . $ds_perilaku["tanggapan"] . "</div>
                            <div style='height:10px;'>&nbsp;</div>
                ...
                $html .= "<table width='100%' cellspacing='0' cellpadding='5' border='0px' style='font-family: sans-serif; font-size: 9pt;'>";
                    $html .= "<tr>";
                        $html .= "<td style='border: solid 1px #000000;' colspan='4' align='left'>
                            ...
                            <div style='height:10px;'>&nbsp;</div>
                            <div style='height:280px;'>" . $ds_perilaku["keputusan"] . "</div>
                            <div style='height:10px;'>&nbsp;</div>
                            <div style='text-align:left;'><i>Tanggal,</i></div>
                        </td>";
                    $html .= "</tr>";
