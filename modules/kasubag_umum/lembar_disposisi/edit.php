...
$b = mysql_query("select id_proses_skrg,catatan from tbl_info_berkas where no_resi = '$resi'");
$bz = mysql_fetch_array($b);
$sta=$_GET["opts"];
if($bz[0]=='22' or $bz[0]=='23' or $bz[0]=='24' or $bz[0]=='25' or $bz[0]=='26' or $bz[0]=='27')
{
	if($bz[0]=='24')
	{
		if($jenis_urus=='04' or $jenis_urus=='05')
		{
			$qry="select id_pengguna,id_proses_lanjutan from tbl_alur_baru where id_proses = '".$bz[0]."' and id_pengguna='4'";
		}
		elseif($jenis_urus=='06')
		{
			$qry="select id_pengguna,id_proses_lanjutan from tbl_alur_baru where id_proses = '".$bz[0]."' and id_pengguna='22'";
		}		
		else
...
<td style="float:right;">
					<img width="90" height="29" 
						onclick="document.location.href='./index.php?mod=kasubag_umum&opt=cek_berkas'" 
...
<fieldset style='width:90%; margin-left:40px; padding-left:20px;min-height:40px; margin-bottom:10px;padding-right:20px;'>
    ...
    <br />
    <br />   
<form action="./modules/kasubag_umum/lembar_disposisi/disposisi_validate.php?link=<?php echo $resi; ?>&id_user=<?php echo $userid; ?>" method="POST">
<table>
<tr>
	<td>DISPOSISI
