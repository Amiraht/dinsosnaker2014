  ...
  <tr>
    <td>
        ...
        <table border="0" style="float:right; margin-top:70px; font-size:18px; font-weight:bold;">
        	<tr>
		         <td style="text-align:right; padding-right:10px; height:20px;"><a style="color:#AA9F00;" href="index.php?mod=menu&do=main">BERANDA UTAMA LOGIN TIM PENGAWASAN</a></td>
            </tr>
        </table>
        </div>
     </td>
   ...
   <div id='content' style='margin-left:5%;width:90%;min-height:350px;'>
	...
	<tr>
		...
		<td style="padding-left:20px;" id='menudepan'>
            <span id="vertical"></span><a href="./index.php?mod=pengawas&opt=cek_berkas" class="menu">PERINTAH PENUGASAN KE LAPANGAN</a><br/><br/><br />
             <span id="vertical"></span><a href="./index.php?mod=pengawas&opt=hasil_lap" class="menu">LAPORAN HASIL VERIFIKASI</a><br/><br/><br/>
            <span id="vertical"></span><a href="./index.php?mod=pengawas&opt=lembar_kendali" class="menu">LEMBAR KENDALI</a><br /><br /><br />
            <span id="vertical"></span><a href="./index.php?mod=loket&opt=laporan" class="menu">LAPORAN-LAPORAN</a><br/><br/><br/>
            <span id="vertical"></span><a href="./index.php?mod=pengawas&opt=user" class="menu">PROFIL USER</a><br/><br/><br/>
