...
function lanjut(id){
    document.location.href="?mod=perilaku_isi&id_skp=" + id + "&id_pegawai=<?php echo($_GET["id_pegawai"]); ?>";
}
</script>
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
              ...
              <table border="0" id='atasan'>
                        ...
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /><a href="./?mod=perilaku_isi_pilih_periode"><span>DATA PERIODE PERILAKU PEGAWAI</span></a></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
			...
			<fieldset>
				<h3 style="text-align: left;">DATA PERIODE PENILAIAN PERILAKU PEGAWAI <?php echo(strtoupper(detail_pegawai($_GET["id_pegawai"], "nama_pegawai"))); ?> 
