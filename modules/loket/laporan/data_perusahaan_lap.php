...
<script type="text/javascript">	
	...
	{	
		...
		var s;
		s='index.php?mod=loket&opt=data_perusahaan_lap';	
		//if(y != '')
		s=s+'&cari='+a+'&usaha='+b+'&modal='+c+'&jenis='+d+'&kel='+e+'&kec='+f+'&tgl='+g+'&klui='+h+'&rekap='+j;
  ...
  <tr >
    <td colspan="2"><div id='header' style='background:url(./image/coba/header2.png) no-repeat;'> 
      <table border="0" id='atasan'">
        	<tr>
		         <td colspan='2' style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00; href="#"><b>LAPORAN DATA PERUSAHAAN</b></a></td>
            </tr>
            <tr>
                ...
                <fieldset>
                   ...
                   <form method='POST' name='fcari'>
                        <table border="0" cellpadding="3">
                        	<tr>
                            	<td width="160px">JENIS LAPORAN</td>
                            	
                            	<td>: <select name="rekap">
                                    <option value='0'>DETAIL</option>
                                    <option value='1'>REKAPITULASI</option></select></td>
                            	<td width="10px">&nbsp;</td>
                                  <td></td>
                                  <td></td>                                
                            </tr>                           
...
?> 
<a href="./modules/loket/laporan/data_perusahaan_lap_cetak.php?mode=1&tgl=<?php echo $_GET["tgl"]; ?>&nama=<?php echo $_GET["nama"]; ?>&klui=<?php echo $_GET["klui"]; ?>&jenis=<?php echo $_GET["jenis"]; ?>&stat_milik=<?php echo $_GET["stat_milik"]; ?>&stat_modal=<?php echo $_GET["stat_modal"]; ?>&stat_usaha=<?php echo $_GET["stat_usaha"]; ?>&kecamatan=<?php echo $_GET["kecamatan"]; ?>&kelurahan=<?php echo $_GET["kelurahan"]; ?>" target="_blank" style="border:none"><img src="./image/printer.png" width="35" height="35" border="0" title="Export to Excel"/></a><br /><br />   
...
<?php 
					...
					echo "<tr>
						...
						<tr>
							...
							<td> $set[3]-$set[5] </td>
							<td> $set[4]</td>
							<td  width='35px'> <a href='javascript:lihat_detail($set[0],\"DINSOSNAKER\");'>LIHAT DETAIL</a> </td>";
						echo"
						</tr>
						<tr>
