...
if ($_GET["mode"]=='1')
{
	...
	HeaderingExcel('Laporan_pp_proses.xls');
	...
	// tabel title=================================================================================
	$worksheet1->write_string(2,1,"LAPORAN PP/PKB yang sedang diproses",$fBesar);
	...
	{						
		$query = mysql_query("select no_resi,tgl_masuk,pengurusan,nama,pemohon,alamat,alamat_pemohon from vw_info_berkas where id_proses_skrg not in('13','14','11','12','81') and isDisposisi='0' and id_pengurusan in ('04','05')");
	}		
