...
<script type="text/javascript">
	...
	s='../../../index.php?mod=kasihubsaker&opt=lembar_disposisi&opts=terima&link='+x+'&id_user='+uid;
		parent.document.location.href=s;
	}	
	
	function tolak(uid){
	var w = '<?php echo "$no_resi"; ?>';
	g='../../../index.php?mod=kasihubsaker&opt=lembar_disposisi&opts=tolak&link='+w+'&id_user='+uid;
	...
	<legend>CHECKLIST PERSYARATAN DAN KELENGKAPAN BERKAS</legend>
	 <p>
				<label>
				  ...
				  SURAT SK PENUGASAN KE LAPANGAN SUDAH SIAP <?php echo $link; ?></label>
				<br>
			  </p>
	<center>
    	<?php
