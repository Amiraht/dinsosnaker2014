...
function lanjut(id){
    document.location.href="?mod=perilaku_lihat&id_skp=" + id;
}
function tambah(id_skp){
    document.location.href='?mod=skp_perilaku_target_tambah&id_skp=' + id_skp;
}
...
function hapus(id_skp){
    jConfirm("Anda yakin akan menghapus data periode penilaian ini?", "PERHATIAN", function(r){
       if(r){
            document.location.href="php/skp/skp_perilaku_target_hapus.php?id_skp=" + id_skp;
       } 
    });
}
</script>
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">DATA PERIODE PERILAKU PEGAWAI</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>PERIODE PERILAKU PEGAWAI</span></td>
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
				...
				<div class="bodypanel">
					<input type="button" value="Tambah Data Periode Perilaku" onclick="tambah(0);" class="btn btn-success"/>
					...
					<?php
						...
						while($ds = mysql_fetch_array($res)){
							...
							echo("<tr>");
								...
								echo("<td>
										<img src='image/Edit-32.png' width='18px' class='linkimage' title='Edit Data Periode' onclick='edit(" . $ds["id_skp_perilaku"] . ")' />
									 </td>");
								echo("<td>
										<img src='image/Delete-32.png' width='18px' class='linkimage' title='Hapus Data Periode' onclick='hapus(" . $ds["id_skp_perilaku"] . ")' />
									 </td>");
								echo("<td>
