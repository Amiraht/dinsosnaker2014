<?php
    ...
    if(!isset($_POST["admin"])){
        $res = mysql_query("SELECT
                            ...
                            WHERE
                            	a.username = '". $username ."' AND a.password = MD5('". $password ."')") or die(mysql_error());
        ...
        $res = mysql_query("SELECT * FROM tbl_pengguna a WHERE (a.id_level = 11 OR id_level = 7) AND a.username = '". $username ."' AND a.password = MD5('". $password ."')")
		        or die(mysql_error());
