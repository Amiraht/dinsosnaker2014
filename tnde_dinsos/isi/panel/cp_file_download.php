...
function hapus(id){
    jConfirm("Anda yakin akan menghapus file ini?", "PERHATIAN", function(r){
        if(r)
            document.location.href = "php/cp_hapus_file_download.php?id=" + id;
    });
}
function edit(id){
    document.location.href = "?mod=cp_tambah_file_download&id=" + id;
}
</script>
<form name="frm" action="?mod=cp_file_download" method="post">
...
<div class="panelcontainer" style="width: 100%;">
    ...
    <div class="bodypanel">
        <input type="button" value="Tambah File Download" onclick="document.location.href='?mod=cp_tambah_file_download';" />
        <div class="kelang"></div>
        ...
        ?>
            <tr>
                ...
                <td>
                    <img src='image/Edit-32.png' width='18px' class='linkimage' title='Edit File Download' onclick='edit(<?php echo($ds["id"]); ?>);' />
                </td>
                <td>
                    <img src='image/Delete-32.png' width='18px' class='linkimage' title='Hapus File Download' onclick='hapus(<?php echo($ds["id"]); ?>);' />
                </td>
            </tr>
        <?php
            }
