...
function lanjut(id){
    document.location.href="?mod=upload_dp3_proses&id=" + id;
}
</script>
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">UPLOAD HASIL PENILAIAN PEGAWAI</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /><a href="./?mod=upload_dp3_pilih_periode"><span>UPLOAD HASIL PENILAIAN PEGAWAI</span></a></td>
