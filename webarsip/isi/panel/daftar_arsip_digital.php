...
function hapusfile(id){
    confirm("Anda yakin ingin menghapus file ini?", "PERHATIAN", function(r){
        if(r){
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">DATA ARSIP DIGITAL</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>DATA ARSIP DIGITAL</span></td>
                            <td><img  align="right" width="90" height="29" onclick="document.location.href='./?mod=daftar_arsip_digital'" 
  ...
  <tr>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
				...
				<fieldset>
					<legend><h3>DATA ARSIP YANG DIPINJAM SECARA DIGITAL</h3></legend>
					<?php
					...
					?>
						<input type="button" value="Kembali" onclick='document.location.href="?mod=peminjaman_digital";' /><br/>
