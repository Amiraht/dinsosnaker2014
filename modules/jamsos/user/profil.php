...
?>
	...
	<style>
		#user input[type="text"], input[type="password"],select
		{
			width:100%;
...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
       ...
       <table border="0" id='atasan'>
        	<tr>
		         <td colspan='2' style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00;" href="#"><b>PROFIL USER</b></a></td>
                    ...
                    <tr>
                  	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='index.php?mod=jamsostek&do=main'>  BERANDA UTAMA LOGIN JAMSOSTEK </a>
  ...
  <tr > 
   ...
   <div id='content' style='margin-left:2%;margin-bottom:20px;width:98%;'>    
    ...
    <legend >PROFIL USER</legend>
		<br />
		<form action='index.php?mod=jamsostek&do=usersimpan' method='post' name='edituser'>
						
    <table width='100%' border='0' cellspacing='2' cellpadding='5' id='user'>
 ...
 <?php
	  ...
	  <tr height='26px'>
        ...
        <td width='3px'>:</td>
        <td align=left ><input id='mytext' name='nip' placeholder='' value='$set[1]' disabled='disable' size='40'></td>
       </tr>
      <tr height='26px'>
        <td>NAMA</td>
        <td>:</td>
        <td><input id='mytext3' name='nama' placeholder='' value='$set[2]' disabled='disable' size='40'></td>
       </tr>
	  <tr height='26px'>
	  <td >NO. TELEPON</td>
        <td >:</td>
        <td ><input id='mytext2' name='telp' placeholder='' value='$set[6]' disabled='disable' size='40'></td>
	  </tr>
	  <tr height='26px'>
	  <td>EMAIL</td>
        <td>:</td>
        <td><input id='mytext4' name='email' placeholder='' value='$set[7]' disabled='disable' size='40'></td>
	  </tr>
	  <tr height='26px'>
        <td>SKPD</td>
        <td>:</td>
	...
	echo"
      ...
      <tr height='28px'>
        <td>ALAMAT</td>
        <td>:</td>
        <td><input id='mytext7' name='alamat' placeholder='' value='$set[5]' disabled='disable' size='40'></td>
        
      </tr>
      <tr height='26px'>
        <td>LEVEL USER</td>
        <td>:</td>
        <td><input id='mytext8' name='level' placeholder='' value='$set[11]' readOnly='true' disabled='disable' size='40'> &nbsp;&nbsp; *Data ini tidak dapat diubah</td>
        
      </tr>
      <tr height='26px'>
        <td>USERNAME</td>
        <td>:</td>
        <td><input id='mytext9' name='username' placeholder='' value='$set[9]' disabled='disable' size='40'></td>
       
      </tr>
      <tr height='26px' id='mypass'>
        <td>PASSWORD</td>
        <td>:</td>
        <td><input  name='id' placeholder='' readOnly='true' size='40'>
	  ...
	  <tr >
		<td colspan='9'>
			<table id='detail' border=0 style='display:none;'>
					...
					<tr height='26px'>
						<td width='190px'>PASSWORD BARU</td>
						<td>:</td>
	...
	?> 
	 ...
	 <!--  <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type='button' id='editbtn' onclick='toggleTextbox()' value='EDIT'></td>
