...
<script type="text/javascript">
	...
	function tolak(uid){
	var x = '<?php echo "$no_resi"; ?>';
	s='../../../index.php?mod=kasubag_umum&opt=lembar_disposisi&opts=tolak&link='+x+'&id_user='+uid;
		parent.document.location.href=s;
	}
	...
	<legend>CHECKLIST PERSYARATAN DAN KELENGKAPAN SURAT</legend>
	 <p>
				<label>
				  ...
				  BERKAS SURAT SUDAH DI CEK <a class="menu" href="../../penomoran/cetak_sk_imta.php?link=<?php echo $no_resi;?>" target="_blank">(SK)</a></label>
				<br>
				<label>
