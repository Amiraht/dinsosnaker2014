...
<tr >
    <td colspan="2"><div id='header' style='background:url(./image/coba/header2.png) no-repeat;'> 
      <table border="0" id='atasan'>
        	<tr>
		         <td colspan='2' style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00;" href="#"><b>LEMBAR KENDALI DETAIL - ARSIP</b></a></td>
            </tr>
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
				  ...
				  <img src="./image/panah.gif"  /><a href="./index.php?mod=arsip&opt=lembar_kendali" id="linkutama">LEMBAR KENDALI</a> 
...
<td style="float:right;">
					<img width="90" height="29" 
						onclick="document.location.href='./index.php?mod=arsip&opt=lembar_kendali'" 
...
<form action="./modules/arsip/lembar_kendali/cetak_disposisi.php?link=<?php echo $resi; ?>" method="POST">
