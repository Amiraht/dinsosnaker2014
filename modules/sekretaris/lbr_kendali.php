...
function Kirim_Cari()
	{
		...
		var s;
		s='./index.php?mod=sekretaris&opt=lembar_kendali';
...
function edit_data(c,uid)
{
		...
		if(t.innerHTML != ''){
			...
			t.innerHTML='<iframe src="./modules/sekretaris/lembar_kendali/edit.php?link='+c+'&id_user='+uid+'" width="100%" style="height:300px" frameborder="0" scrolling="no" id="iframe_detail"></iframe>';
...
function lihat_data(k,uid)
{
		...
		if(t.innerHTML != ''){
			...
			t.innerHTML='<iframe src="./modules/sekretaris/lembar_kendali/lihat.php?link='+k+'&id_user='+uid+'" width="100%" style="height:300px" frameborder="0" scrolling="yes" id="iframe_detail"></iframe>';
...
function lihat_kendali(k,uid)
	{
		var s;
		s='./index.php?mod=sekretaris&opt=lihat_kendali';
		if(k != '')
		s=s+'&link='+k;
		if(uid != '')
		s=s+'&id_user='+uid;
	...
	<tr>
		...
		?>
				...
				<?php 
					...
					echo "<td align=center><input type='button' value='LIHAT' onClick=$onc2></td>
					</tr>";
						$i++;
					echo "
					<tr>
