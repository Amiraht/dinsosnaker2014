...
<table width="1024" border="0" cellspacing="2" cellpadding="5">
          ...
          <table border="0" id='atasan'">
            ...
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='index.php?mod=loket&opt=main'> <span></span> BERANDA UTAMA LOGIN LOKET </a>
                     <span> </span> <img src="./image/panah.gif" /> <span> </span> <a href="index.php?mod=loket&opt=daftar">PENDAFTARAN, UPDATE DAN VERIFIKASI PERUSAHAAN</a>
  ...
  <tr>
    ...
    <form action="./index.php?mod=loket&opt=daftar&act=validate" method='post'>
	<table width="100%" border="0" align="center" cellpadding="5px">
	  ...
	  <tr>
	    <td>KLUI</td>
	    <td>:</td>
	    <td colspan="5"><?php echo $u."-".$data7[0]; ?></td>
	    </tr>
	  <tr>
	    <td colspan="3">&nbsp;</td>
	    <td width="5%">&nbsp;</td>
