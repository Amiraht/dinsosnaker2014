...
<script type="text/javascript">
	...
	//s='../../../index.php?mod=kasihubsaker&opt=cek_berkas&opts=terima&value='+x+'&id_user='+uid;
	...
	function tolak(uid){
	var x = '<?php echo "$no_resi"; ?>';
	s='../../../index.php?mod=kasihubsaker&opt=lembar_disposisi&opts=tolak&link='+x+'&id_user='+uid;
		parent.document.location.href=s;
	}
...
$data_khusus = mysql_query("select * from tbl_berkas_janji where no_resi='".$no_resi."'");
...
<fieldset>
	...
	<center>
        ...
        <span> BERDASARKAN HASIL PEMERIKSAAN BERKAS, MAKA PENGURUSAN PKB INI :</span><br/><br/>
		<!--<input type="button" onClick="<?php echo $onc1?>" value="DI TOLAK">-->
		<input type="button" onClick="<?php echo $onc?>" value="LANJUT" disabled id="btn">
	</center>
<div id='div_cek'></div>
	</fieldset>
<fieldset>
