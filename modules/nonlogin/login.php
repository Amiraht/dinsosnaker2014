  ...
  <tr>
    <td><div id='headerdepan' style='background:url(./image/coba/header.png) no-repeat;'>
      <table border="0" style="float:right; margin-top:70px; font-size:23px; font-weight:bold;">
        	<tr>
		         <td style="text-align:right; padding-right:10px; height:20px;"> <a style='color:#AA9F00;' href='index.php?mod=umum&do=login'>LOGIN UTAMA</a></td>
            </tr>
        </table>
		</div></td>
  </tr>
  <tr>
    <td>
     <div id='content' style='
        ...
        min-height:350px;'
        >
			<form action="./index.php?mod=umum&do=validasi" method='POST'>
			<table width="90%" border='0px' style='margin-left: 48px; height:310px;'>
							...
							<tr>
							  ...
							  <td><input name="user" type="text" maxlength="20" placeholder="Username" /></td>
			  </tr>
							<tr>
