<script type="text/javascript">
	...
	s='./index.php?mod=kasiwasnaker&opt=buat_surat&opts='+sp+'&link='+x+'&uid='+uid;
	...
	//var x = '<?php echo "$no_resi"; ?>';
	s='./index.php?mod=kasiwasnaker&opt=lembar_disposisi&opts=periksa&link='+x+'&id_user='+uid;
		parent.document.location.href=s;
	}
...
<tr >
    <td colspan="2"><div id='header' style='background:url(./image/coba/header2.png) no-repeat;'> 
      <table border="0" id='atasan'>
        	<tr>
		         <td colspan='2' style="text-align:right; padding-right:10px; padding-bottom:50px;"><a style="color:#AA9F00;" href="#"><b>PEMILIHAN TIM PEMERIKSA</b></a></td>
            </tr>
            <tr>
            	 <td style="text-align:left; padding-left:10px; border-left:0px solid black;">
                  ...
                  <img src="./image/panah.gif"  /><a href="./index.php?mod=kasiwasnaker&amp;opt=main" id="linkutama"> PEMILIHAN TIM PEMERIKSA</a> 
                 </td>
...
<form action="./modules/kasiwasnaker/tim_periksa/tim_validate.php?mode=1&link=<?php echo $resi; ?>&amp;id_user=<?php echo $userid; ?>&amp;status=<?php echo $sta; ?>" method="POST">
<table>
<tr>
	<td>NAMA</td>
    <td></td>
	<td> 
		...
		$rt = "select id_user,nama,level from user where level in('11','12','13')";
		$ac = mysql_query($rt);
	...
	$id_tim=$data[2];
		echo"
			<tr>
				...
				<td>$gol</td>
				<td>$data[1]</td>
				<td><a href=./modules/kasiwasnaker/tim_periksa/tim_validate.php?mode=2&link=$resi&id_user=$userid&id_tim=$id_tim>HAPUS</a></td>
			</tr>";
			$no++;	
	}
	echo "</table>
