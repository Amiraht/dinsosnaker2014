...
function nomor_nodin($id_level, $tahun){
	...
	// fungsi untuk menangani masalah injeksi pada input form
	...
	function decode($encode_string){
		$decode_string = base64_decode(base64_decode(base64_decode(base64_decode(base64_decode($encode_string)))));
