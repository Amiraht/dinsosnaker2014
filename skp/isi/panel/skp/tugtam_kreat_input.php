...
<?php
	$id_pegawai = mysql_real_escape_string(trim(str_replace("*,',<,>,", "", $_GET['id_pegawai'])));
        	...
        	<div id='header' style='background:url(./image/coba/header2.png) no-repeat;'>
              <table border="0" id='atasan'>
                        <tr>
                                ...
                                <h1><a style="color:#AA9F00;" href="">INPUT TUGAS, TAMBAH DAN KREATIVITAS</a></h1>
                                </td>
                        </tr>
                        <tr>
                            <td style="text-align:left; padding-left:10px; border-left:0px solid black;"><a href='./'> <span></span> BERANDA UTAMA </a>
                                 <span> </span> <img src="./image/panah.gif" /> <span>INPUT TUGAS, TAMBAH DAN KREATIVITAS</span></td>
    ...
    <div id='content' style='padding-top:10px;'>	<br>
				<input type="button" value="Kembali" onclick="document.location.href='?mod=tugtam_kreat_input_pilih_periode';" />
					...
					<div class="panelcontainer" style="width: 100%;">
						<h3 style="text-align: left;">ISI DATA TUGAS TAMBAHAN <?php echo(strtoupper(detail_pegawai($id_pegawai, "nama_pegawai"))); ?> (NIP : <?php echo(strtoupper(detail_pegawai($id_pegawai, "nip"))); ?>)</h3>
						<div class="bodypanel">
						...
						<table border="0px" cellspacing='0' cellpadding='0' width='100%' class="listingtable">
							...
							<tbody>
							<?php
								$res_tugas_tambahan = mysql_query("SELECT * FROM tbl_skp_tugas_tambahan WHERE id_skp='" . $id_skp . "'");
								$no_tugas_tambahan = 0;
					...
					<div class="panelcontainer" style="width: 100%;">
						<h3 style="text-align: left;">ISI DATA KREATIFITAS <?php echo(strtoupper(detail_pegawai($id_pegawai, "nama_pegawai"))); ?> (NIP : <?php echo(strtoupper(detail_pegawai($id_pegawai, "nip"))); ?>)</h3>
						<div class="bodypanel">
						<table border="0px" cellspacing='0' cellpadding='0' width='100%'>
							<tr>
								<td>
							...
							<tr>
								<td>
									...
									<select name="nilai">
									<?php
										$res_kriteria = mysql_query("SELECT * FROM ref_kriteria_kreatifitas ORDER BY id_kriteria ASC");
										while($ds_kriteria = mysql_fetch_array($res_kriteria)){
											echo("<option value='" . $ds_kriteria["nilai"] . "'>" . $ds_kriteria["kriteria"] . "</option>");
										}
									?>
									</select>
								</td>
						...
						<table border="0px" cellspacing='0' cellpadding='0' width='100%' class="listingtable">
							...
							<tbody>
							<?php
								$res_tugas_tambahan = mysql_query("SELECT * FROM tbl_skp_kreatifitas WHERE id_skp='" . $id_skp . "'");
								$no_tugas_tambahan = 0;
								while($ds_tugas_tambahan = mysql_fetch_array($res_tugas_tambahan)){
									$no_tugas_tambahan++;
									echo("<tr>");
										...
										echo("<td align='center'>" . $ds_tugas_tambahan["nilai"] . "</td>");
										echo("<td>
